...
const BODY: (string | { h: string; id: string })[] = [
  ...
  { h: "How the dog became a blueprint", id: "blueprint" },
  ...
  { h: "Why bother, when the dogs already work?", id: "why-bother" },
  ...
  { h: "The machine that breathes you in", id: "breathes" },
  ...
  { h: "So is the dog out of a job?", id: "out-of-job" },
  ...
  { h: "What we owe the blueprint", id: "owe-blueprint" },
...
// the tail bucket (how an e-nose works, the medical trilogy, sources), since
// there are more cards than headings. Pairing is by heading id, never array order.
...
const HEADLINE = "The Machine That May Owe Dogs a Biscuit";
  ...
  "@graph": [
    {
      ...
      image: `${SITE_URL}/never-clocking-off.jpg`,
      publisher: { "@id": `${SITE_URL}/#organization` },
      mainEntityOfPage: `${SITE_URL}/dogs-at-work/the-electronic-nose`,
    },
    {
      "@type": "BreadcrumbList",
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: HEADLINE, item: `${SITE_URL}/dogs-at-work/the-electronic-nose` },
      ],
    },
  ],
};
      ...
      <main className={styles.essayPage}>
        <div className={styles.essayHero}>
          ...
          <div className={styles.essayHeroContent}>
            ...
            <h1 className={styles.essayHeroTitle}>The Machine That May Owe Dogs a Biscuit</h1>
          </div>
        </div>
