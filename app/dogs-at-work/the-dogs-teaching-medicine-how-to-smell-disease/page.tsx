...
const BODY: (string | { h: string; id: string })[] = [
  ...
  { h: "What the dog is actually smelling", id: "what-smelling" },
  ...
  { h: "A game show for noses", id: "game-show" },
  ...
  { h: "But no, your dog can't diagnose your cancer", id: "no-diagnose" },
  ...
  { h: "The dog doesn't become the machine. The dog invents it.", id: "invents" },
