...
export default function BreedStrip({
  ...
  /* How long playOnArrival waits before the circles fall. PLAY_ON_ARRIVAL_MS if
  ...
  const modal = active && (
    <LineageModal
      ...
      startDelayMs={playOnArrival && active.name === initialLevel ? arrivalDelayMs ?? PLAY_ON_ARRIVAL_MS : 0}
