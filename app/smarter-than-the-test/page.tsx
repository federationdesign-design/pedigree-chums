      ...
      <main className={styles.essayPage}>
        <div className={styles.essayHero}>
          ...
          <div className={styles.essayHeroContent}>
            ...
            <h1 className={styles.essayHeroTitle}>Your Dog Is Smarter Than the Test: Why the Maze Isn't the Measure</h1>
          </div>
        </div>
