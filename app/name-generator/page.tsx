...
function scoreName(title: TitleEntry, first: NameEntry, dogWord: WordEntry, surname: string, colour: DogColour = "", group = ""): number {
  ...
  if (title.title.includes(" ") && first.reg === "pedigree") score -= 1;
    ...
    // ── Booboo dominates too much -- slight cap ──────────────────────────────────
  if (first.name === "Booboo") score -= 4;

  // ── Penalise first name = dog word (Lurk Lurk, Tumble Tumble) ──────────────
    if (first.name.toLowerCase() === dogWord.word.toLowerCase()) score -= 8;

    // ── Penalise 4-word names (multi-word title + two-word name = too long) ──────
    if (title.title.includes(" ") && first.name.includes(" ")) score -= 5;
  ...
  // On lapdog -- long compound whimsy names (>10 chars) also penalised
  if (group === "lapdog" && whimsyPattern.test(first.name) && first.name.length > 10) score -= 5;
  // Everywhere -- very long compound whimsy names (>12 chars) are too much
  if (whimsyPattern.test(first.name) && first.name.length > 12) score -= 4;
...
const BOY_TITLES: Record<string, TitleEntry[]> = {
  ...
  terrier:    [{title:"Mr",reg:"mundane",syllables:1},{title:"Sir",reg:"grand",syllables:1}],
...
const GIRL_TITLES: Record<string, TitleEntry[]> = {
  ...
  lapdog:     [{title:"Lil'",reg:"informal",syllables:1},{title:"Baby",reg:"informal",syllables:2},{title:"Little",reg:"informal",syllables:2},{title:"Scruffy",reg:"informal",syllables:2},{title:"Fluffy",reg:"informal",syllables:2},{title:"Grumpy",reg:"informal",syllables:2},{title:"Squishy",reg:"informal",syllables:2},{title:"Itsy",reg:"informal",syllables:2},{title:"Queen",reg:"grand",syllables:1},{title:"Princess",reg:"grand",syllables:3},{title:"Goddess",reg:"grand",syllables:2},{title:"Enchantress",reg:"grand",syllables:3},{title:"Crystal Queen",reg:"grand",syllables:4},{title:"Moon Queen",reg:"grand",syllables:3},{title:"Rose Queen",reg:"grand",syllables:2},{title:"Diamond Queen",reg:"grand",syllables:4},{title:"Pearl Queen",reg:"grand",syllables:2}],
...
const DOG_WORDS: Record<string, WordEntry[]> = {
  spaniel:     [{word:"Flush",reg:"mundane",firstLetter:"f"},{word:"Fetch",reg:"mundane",firstLetter:"f"},{word:"Waggle",reg:"mundane",firstLetter:"w"},{word:"Splash",reg:"mundane",firstLetter:"s"},{word:"Frolic",reg:"chaos",firstLetter:"f"},{word:"Prance",reg:"grand",firstLetter:"p"},{word:"Scamper",reg:"chaos",firstLetter:"s"},{word:"Bound",reg:"mundane",firstLetter:"b"},{word:"Romp",reg:"chaos",firstLetter:"r"},{word:"Paddle",reg:"mundane",firstLetter:"p"},{word:"Leap",reg:"mundane",firstLetter:"l"},{word:"Spring",reg:"chaos",firstLetter:"s"},{word:"Dash",reg:"chaos",firstLetter:"d"},{word:"Plunge",reg:"mundane",firstLetter:"p"},{word:"Wade",reg:"mundane",firstLetter:"w"},{word:"Snuffle",reg:"mundane",firstLetter:"s"},{word:"Ramble",reg:"mundane",firstLetter:"r"},{word:"Dart",reg:"chaos",firstLetter:"d"},{word:"Lunge",reg:"chaos",firstLetter:"l"},{word:"Gambol",reg:"chaos",firstLetter:"g"},{word:"Charge",reg:"chaos",firstLetter:"c"}],
  retriever:   [{word:"Fetch",reg:"mundane",firstLetter:"f"},{word:"Wag",reg:"mundane",firstLetter:"w"},{word:"Scoff",reg:"mundane",firstLetter:"s"},{word:"Snuffle",reg:"mundane",firstLetter:"s"},{word:"Mooch",reg:"mundane",firstLetter:"m"},{word:"Slurp",reg:"mundane",firstLetter:"s"},{word:"Devour",reg:"mundane",firstLetter:"d"},{word:"Bound",reg:"mundane",firstLetter:"b"},{word:"Lollop",reg:"mundane",firstLetter:"l"},{word:"Beg",reg:"mundane",firstLetter:"b"},{word:"Drool",reg:"mundane",firstLetter:"d"},{word:"Nuzzle",reg:"mundane",firstLetter:"n"},{word:"Paddle",reg:"mundane",firstLetter:"p"},{word:"Plunge",reg:"mundane",firstLetter:"p"},{word:"Lumber",reg:"mundane",firstLetter:"l"},{word:"Amble",reg:"mundane",firstLetter:"a"},{word:"Dawdle",reg:"mundane",firstLetter:"d"},{word:"Shamble",reg:"chaos",firstLetter:"s"},{word:"Gobble",reg:"mundane",firstLetter:"g"},{word:"Chomp",reg:"mundane",firstLetter:"c"},{word:"Lounge",reg:"mundane",firstLetter:"l"}],
  collie:      [{word:"Herd",reg:"mundane",firstLetter:"h"},{word:"Dart",reg:"chaos",firstLetter:"d"},{word:"Circle",reg:"mundane",firstLetter:"c"},{word:"Weave",reg:"mundane",firstLetter:"w"},{word:"Dash",reg:"chaos",firstLetter:"d"},{word:"Sprint",reg:"chaos",firstLetter:"s"},{word:"Round",reg:"mundane",firstLetter:"r"},{word:"Chase",reg:"chaos",firstLetter:"c"},{word:"Eye",reg:"mundane",firstLetter:"e"},{word:"Stalk",reg:"grand",firstLetter:"s"},{word:"Gather",reg:"mundane",firstLetter:"g"},{word:"Patrol",reg:"grand",firstLetter:"p"},{word:"Flank",reg:"grand",firstLetter:"f"},{word:"Loop",reg:"mundane",firstLetter:"l"},{word:"Heel",reg:"mundane",firstLetter:"h"},{word:"Work",reg:"mundane",firstLetter:"w"},{word:"Drive",reg:"mundane",firstLetter:"d"},{word:"Pen",reg:"mundane",firstLetter:"p"},{word:"Cut",reg:"mundane",firstLetter:"c"},{word:"Course",reg:"grand",firstLetter:"c"},{word:"Track",reg:"mundane",firstLetter:"t"}],
  boxer:       [{word:"Charge",reg:"chaos",firstLetter:"c"},{word:"Barrel",reg:"chaos",firstLetter:"b"},{word:"Blunder",reg:"chaos",firstLetter:"b"},{word:"Crash",reg:"chaos",firstLetter:"c"},{word:"Bounce",reg:"chaos",firstLetter:"b"},{word:"Wobble",reg:"chaos",firstLetter:"w"},{word:"Stumble",reg:"chaos",firstLetter:"s"},{word:"Bumble",reg:"chaos",firstLetter:"b"},{word:"Bluster",reg:"mundane",firstLetter:"b"},{word:"Gambol",reg:"chaos",firstLetter:"g"},{word:"Lunge",reg:"chaos",firstLetter:"l"},{word:"Pummel",reg:"chaos",firstLetter:"p"},{word:"Swagger",reg:"mundane",firstLetter:"s"},{word:"Barge",reg:"chaos",firstLetter:"b"},{word:"Bulldoze",reg:"mundane",firstLetter:"b"},{word:"Cannon",reg:"chaos",firstLetter:"c"},{word:"Rampage",reg:"chaos",firstLetter:"r"},{word:"Careen",reg:"chaos",firstLetter:"c"},{word:"Plunge",reg:"mundane",firstLetter:"p"},{word:"Hurtle",reg:"chaos",firstLetter:"h"},{word:"Clobber",reg:"chaos",firstLetter:"c"},{word:"Muscle",reg:"mundane",firstLetter:"m"},{word:"Thunder",reg:"grand",firstLetter:"t"},{word:"Bludgeon",reg:"chaos",firstLetter:"b"}],
  sniffer:     [{word:"Sniff",reg:"mundane",firstLetter:"s"},{word:"Sleuth",reg:"mundane",firstLetter:"s"},{word:"Hunt",reg:"mundane",firstLetter:"h"},{word:"Nose",reg:"mundane",firstLetter:"n"},{word:"Track",reg:"mundane",firstLetter:"t"},{word:"Hound",reg:"mundane",firstLetter:"h"},{word:"Quest",reg:"mundane",firstLetter:"q"},{word:"Finder",reg:"mundane",firstLetter:"f"},{word:"Detect",reg:"mundane",firstLetter:"d"},{word:"Trail",reg:"mundane",firstLetter:"t"},{word:"Pursue",reg:"mundane",firstLetter:"p"},{word:"Follow",reg:"mundane",firstLetter:"f"},{word:"Flush",reg:"mundane",firstLetter:"f"},{word:"Course",reg:"grand",firstLetter:"c"},{word:"Scout",reg:"mundane",firstLetter:"s"},{word:"Investigate",reg:"mundane",firstLetter:"i"},{word:"Search",reg:"mundane",firstLetter:"s"},{word:"Unearth",reg:"mundane",firstLetter:"u"},{word:"Retrieve",reg:"mundane",firstLetter:"r"},{word:"Scent",reg:"mundane",firstLetter:"s"},{word:"Mark",reg:"mundane",firstLetter:"m"},{word:"Quarter",reg:"mundane",firstLetter:"q"},{word:"Work",reg:"mundane",firstLetter:"w"},{word:"Point",reg:"mundane",firstLetter:"p"}],
  afghan:      [{word:"Glide",reg:"grand",firstLetter:"g"},{word:"Sweep",reg:"grand",firstLetter:"s"},{word:"Flow",reg:"grand",firstLetter:"f"},{word:"Drift",reg:"mundane",firstLetter:"d"},{word:"Surge",reg:"chaos",firstLetter:"s"},{word:"Race",reg:"chaos",firstLetter:"r"},{word:"Flash",reg:"chaos",firstLetter:"f"},{word:"Streak",reg:"chaos",firstLetter:"s"},{word:"Soar",reg:"chaos",firstLetter:"s"},{word:"Float",reg:"grand",firstLetter:"f"},{word:"Skim",reg:"mundane",firstLetter:"s"},{word:"Slip",reg:"mundane",firstLetter:"s"},{word:"Course",reg:"grand",firstLetter:"c"},{word:"Sail",reg:"grand",firstLetter:"s"},{word:"Billow",reg:"grand",firstLetter:"b"},{word:"Pour",reg:"mundane",firstLetter:"p"},{word:"Roll",reg:"chaos",firstLetter:"r"},{word:"Ripple",reg:"mundane",firstLetter:"r"},{word:"Waft",reg:"grand",firstLetter:"w"},{word:"Breeze",reg:"grand",firstLetter:"b"},{word:"Fly",reg:"chaos",firstLetter:"f"},{word:"Shimmer",reg:"grand",firstLetter:"s"},{word:"Blaze",reg:"chaos",firstLetter:"b"},{word:"Arrow",reg:"chaos",firstLetter:"a"}],
  sighthound:  [{word:"Sprint",reg:"chaos",firstLetter:"s"},{word:"Dart",reg:"chaos",firstLetter:"d"},{word:"Bolt",reg:"chaos",firstLetter:"b"},{word:"Flash",reg:"chaos",firstLetter:"f"},{word:"Streak",reg:"chaos",firstLetter:"s"},{word:"Glide",reg:"grand",firstLetter:"g"},{word:"Scorch",reg:"chaos",firstLetter:"s"},{word:"Race",reg:"chaos",firstLetter:"r"},{word:"Sweep",reg:"grand",firstLetter:"s"},{word:"Blur",reg:"chaos",firstLetter:"b"},{word:"Arrow",reg:"chaos",firstLetter:"a"},{word:"Fly",reg:"chaos",firstLetter:"f"},{word:"Launch",reg:"chaos",firstLetter:"l"},{word:"Tear",reg:"chaos",firstLetter:"t"},{word:"Hurtle",reg:"chaos",firstLetter:"h"},{word:"Rocket",reg:"chaos",firstLetter:"r"},{word:"Charge",reg:"chaos",firstLetter:"c"},{word:"Accelerate",reg:"mundane",firstLetter:"a"},{word:"Explode",reg:"chaos",firstLetter:"e"},{word:"Surge",reg:"chaos",firstLetter:"s"},{word:"Course",reg:"grand",firstLetter:"c"},{word:"Chase",reg:"chaos",firstLetter:"c"},{word:"Pursue",reg:"mundane",firstLetter:"p"},{word:"Drive",reg:"mundane",firstLetter:"d"}],
  greatdane:   [{word:"Orbit",reg:"grand",firstLetter:"o"},{word:"Launch",reg:"chaos",firstLetter:"l"},{word:"Soar",reg:"chaos",firstLetter:"s"},{word:"Surge",reg:"chaos",firstLetter:"s"},{word:"Blaze",reg:"chaos",firstLetter:"b"},{word:"Streak",reg:"chaos",firstLetter:"s"},{word:"Thunder",reg:"grand",firstLetter:"t"},{word:"Stomp",reg:"mundane",firstLetter:"s"},{word:"Lumber",reg:"mundane",firstLetter:"l"},{word:"Loom",reg:"grand",firstLetter:"l"},{word:"Tower",reg:"grand",firstLetter:"t"},{word:"Lope",reg:"mundane",firstLetter:"l"},{word:"Stride",reg:"grand",firstLetter:"s"},{word:"March",reg:"grand",firstLetter:"m"},{word:"Rumble",reg:"mundane",firstLetter:"r"},{word:"Sway",reg:"chaos",firstLetter:"s"},{word:"Plod",reg:"chaos",firstLetter:"p"},{word:"Prowl",reg:"grand",firstLetter:"p"},{word:"Lurch",reg:"chaos",firstLetter:"l"},{word:"Amble",reg:"mundane",firstLetter:"a"},{word:"Trundle",reg:"mundane",firstLetter:"t"},{word:"Patrol",reg:"grand",firstLetter:"p"},{word:"Cruise",reg:"mundane",firstLetter:"c"},{word:"Glide",reg:"grand",firstLetter:"g"}],
  giant:       [{word:"Lumber",reg:"mundane",firstLetter:"l"},{word:"Plod",reg:"chaos",firstLetter:"p"},{word:"Stomp",reg:"mundane",firstLetter:"s"},{word:"Thud",reg:"mundane",firstLetter:"t"},{word:"Rumble",reg:"mundane",firstLetter:"r"},{word:"Sway",reg:"chaos",firstLetter:"s"},{word:"Thunder",reg:"grand",firstLetter:"t"},{word:"Shamble",reg:"chaos",firstLetter:"s"},{word:"Quake",reg:"mundane",firstLetter:"q"},{word:"Heave",reg:"mundane",firstLetter:"h"},{word:"Tromp",reg:"mundane",firstLetter:"t"},{word:"Wade",reg:"mundane",firstLetter:"w"},{word:"Trudge",reg:"mundane",firstLetter:"t"},{word:"Trundle",reg:"mundane",firstLetter:"t"},{word:"Lurch",reg:"chaos",firstLetter:"l"},{word:"Crash",reg:"chaos",firstLetter:"c"},{word:"Barge",reg:"chaos",firstLetter:"b"},{word:"Hulk",reg:"mundane",firstLetter:"h"},{word:"Tramp",reg:"mundane",firstLetter:"t"},{word:"Slog",reg:"chaos",firstLetter:"s"},{word:"Haul",reg:"mundane",firstLetter:"h"},{word:"Drag",reg:"mundane",firstLetter:"d"},{word:"Tread",reg:"mundane",firstLetter:"t"},{word:"March",reg:"grand",firstLetter:"m"}],
  poodle:      [{word:"Prance",reg:"grand",firstLetter:"p"},{word:"Strut",reg:"grand",firstLetter:"s"},{word:"Waltz",reg:"grand",firstLetter:"w"},{word:"Glide",reg:"grand",firstLetter:"g"},{word:"Mince",reg:"grand",firstLetter:"m"},{word:"Flourish",reg:"grand",firstLetter:"f"},{word:"Pirouette",reg:"grand",firstLetter:"p"},{word:"Pose",reg:"grand",firstLetter:"p"},{word:"Primp",reg:"mundane",firstLetter:"p"},{word:"Shimmy",reg:"mundane",firstLetter:"s"},{word:"Float",reg:"grand",firstLetter:"f"},{word:"Twirl",reg:"mundane",firstLetter:"t"},{word:"Step",reg:"mundane",firstLetter:"s"},{word:"Parade",reg:"grand",firstLetter:"p"},{word:"Proceed",reg:"grand",firstLetter:"p"},{word:"Process",reg:"grand",firstLetter:"p"},{word:"Advance",reg:"grand",firstLetter:"a"},{word:"Perform",reg:"grand",firstLetter:"p"},{word:"Present",reg:"grand",firstLetter:"p"},{word:"Display",reg:"grand",firstLetter:"d"},{word:"Flaunt",reg:"grand",firstLetter:"f"}],
  lapdog:      [{word:"Prance",reg:"grand",firstLetter:"p"},{word:"Bounce",reg:"chaos",firstLetter:"b"},{word:"Waltz",reg:"grand",firstLetter:"w"},{word:"Fluff",reg:"mundane",firstLetter:"f"},{word:"Pamper",reg:"mundane",firstLetter:"p"},{word:"Flutter",reg:"mundane",firstLetter:"f"},{word:"Sparkle",reg:"mundane",firstLetter:"s"},{word:"Skip",reg:"chaos",firstLetter:"s"},{word:"Patter",reg:"mundane",firstLetter:"p"},{word:"Toddle",reg:"chaos",firstLetter:"t"},{word:"Wiggle",reg:"chaos",firstLetter:"w"},{word:"Waddle",reg:"chaos",firstLetter:"w"},{word:"Shimmer",reg:"grand",firstLetter:"s"},{word:"Twirl",reg:"mundane",firstLetter:"t"},{word:"Dance",reg:"mundane",firstLetter:"d"},{word:"Fuss",reg:"mundane",firstLetter:"f"},{word:"Nestle",reg:"mundane",firstLetter:"n"},{word:"Cuddle",reg:"mundane",firstLetter:"c"},{word:"Nuzzle",reg:"mundane",firstLetter:"n"},{word:"Frolic",reg:"chaos",firstLetter:"f"},{word:"Bustle",reg:"mundane",firstLetter:"b"},{word:"Scamper",reg:"chaos",firstLetter:"s"}],
  boston:      [{word:"Scrap",reg:"chaos",firstLetter:"s"},{word:"Hustle",reg:"chaos",firstLetter:"h"},{word:"Brawl",reg:"chaos",firstLetter:"b"},{word:"Charge",reg:"chaos",firstLetter:"c"},{word:"Dodge",reg:"mundane",firstLetter:"d"},{word:"Rattle",reg:"chaos",firstLetter:"r"},{word:"Jabber",reg:"mundane",firstLetter:"j"},{word:"Strut",reg:"grand",firstLetter:"s"},{word:"March",reg:"grand",firstLetter:"m"},{word:"Bluster",reg:"mundane",firstLetter:"b"},{word:"Swagger",reg:"mundane",firstLetter:"s"},{word:"Lunge",reg:"chaos",firstLetter:"l"},{word:"Dart",reg:"chaos",firstLetter:"d"},{word:"Spring",reg:"chaos",firstLetter:"s"},{word:"Bounce",reg:"chaos",firstLetter:"b"},{word:"Clash",reg:"chaos",firstLetter:"c"},{word:"Spar",reg:"mundane",firstLetter:"s"},{word:"Feint",reg:"mundane",firstLetter:"f"},{word:"Weave",reg:"mundane",firstLetter:"w"},{word:"Duck",reg:"mundane",firstLetter:"d"},{word:"Bob",reg:"mundane",firstLetter:"b"},{word:"Jab",reg:"mundane",firstLetter:"j"},{word:"Swerve",reg:"mundane",firstLetter:"s"},{word:"Caper",reg:"chaos",firstLetter:"c"}],
  welsh:       [{word:"Herd",reg:"mundane",firstLetter:"h"},{word:"Chase",reg:"chaos",firstLetter:"c"},{word:"Round",reg:"mundane",firstLetter:"r"},{word:"Bound",reg:"mundane",firstLetter:"b"},{word:"Circle",reg:"mundane",firstLetter:"c"},{word:"Weave",reg:"mundane",firstLetter:"w"},{word:"Dash",reg:"chaos",firstLetter:"d"},{word:"Drive",reg:"mundane",firstLetter:"d"},{word:"Heel",reg:"mundane",firstLetter:"h"},{word:"Work",reg:"mundane",firstLetter:"w"},{word:"Patrol",reg:"grand",firstLetter:"p"},{word:"Course",reg:"grand",firstLetter:"c"},{word:"Dart",reg:"chaos",firstLetter:"d"},{word:"Sprint",reg:"chaos",firstLetter:"s"},{word:"Quarter",reg:"mundane",firstLetter:"q"},{word:"Pen",reg:"mundane",firstLetter:"p"},{word:"Cut",reg:"mundane",firstLetter:"c"},{word:"Flank",reg:"grand",firstLetter:"f"},{word:"Loop",reg:"mundane",firstLetter:"l"},{word:"Eye",reg:"mundane",firstLetter:"e"},{word:"Track",reg:"mundane",firstLetter:"t"},{word:"Direct",reg:"grand",firstLetter:"d"},{word:"Guide",reg:"mundane",firstLetter:"g"}],
  asian:       [{word:"Strike",reg:"mundane",firstLetter:"s"},{word:"Pounce",reg:"chaos",firstLetter:"p"},{word:"Dodge",reg:"mundane",firstLetter:"d"},{word:"Prowl",reg:"grand",firstLetter:"p"},{word:"Stalk",reg:"grand",firstLetter:"s"},{word:"Lunge",reg:"chaos",firstLetter:"l"},{word:"Waddle",reg:"chaos",firstLetter:"w"},{word:"Tumble",reg:"chaos",firstLetter:"t"},{word:"Snort",reg:"chaos",firstLetter:"s"},{word:"Shuffle",reg:"chaos",firstLetter:"s"},{word:"Crouch",reg:"mundane",firstLetter:"c"},{word:"Spring",reg:"chaos",firstLetter:"s"},{word:"Slink",reg:"mundane",firstLetter:"s"},{word:"Strut",reg:"grand",firstLetter:"s"},{word:"Posture",reg:"mundane",firstLetter:"p"},{word:"Observe",reg:"mundane",firstLetter:"o"},{word:"Contemplate",reg:"mundane",firstLetter:"c"},{word:"Sit",reg:"mundane",firstLetter:"s"},{word:"Watch",reg:"mundane",firstLetter:"w"},{word:"Guard",reg:"grand",firstLetter:"g"},{word:"Patrol",reg:"grand",firstLetter:"p"},{word:"Perch",reg:"mundane",firstLetter:"p"},{word:"Survey",reg:"grand",firstLetter:"s"},{word:"Reign",reg:"grand",firstLetter:"r"}],
  character:   [{word:"Snort",reg:"chaos",firstLetter:"s"},{word:"Waddle",reg:"chaos",firstLetter:"w"},{word:"Tumble",reg:"chaos",firstLetter:"t"},{word:"Bumble",reg:"chaos",firstLetter:"b"},{word:"Wobble",reg:"chaos",firstLetter:"w"},{word:"Totter",reg:"chaos",firstLetter:"t"},{word:"Blunder",reg:"chaos",firstLetter:"b"},{word:"Grumble",reg:"chaos",firstLetter:"g"},{word:"Wheeze",reg:"chaos",firstLetter:"w"},{word:"Puff",reg:"chaos",firstLetter:"p"},{word:"Dawg",reg:"mundane",firstLetter:"d"},{word:"Lumber",reg:"mundane",firstLetter:"l"},{word:"Shuffle",reg:"chaos",firstLetter:"s"},{word:"Stumble",reg:"chaos",firstLetter:"s"},{word:"Topple",reg:"chaos",firstLetter:"t"},{word:"Careen",reg:"chaos",firstLetter:"c"},{word:"Flounder",reg:"chaos",firstLetter:"f"},{word:"Plod",reg:"chaos",firstLetter:"p"},{word:"Teeter",reg:"chaos",firstLetter:"t"},{word:"Sway",reg:"chaos",firstLetter:"s"},{word:"Stagger",reg:"chaos",firstLetter:"s"},{word:"Lurch",reg:"chaos",firstLetter:"l"},{word:"Reel",reg:"chaos",firstLetter:"r"},{word:"Roll",reg:"chaos",firstLetter:"r"}],
  terrier:     [{word:"Dig",reg:"chaos",firstLetter:"d"},{word:"Dart",reg:"chaos",firstLetter:"d"},{word:"Dash",reg:"chaos",firstLetter:"d"},{word:"Scrap",reg:"chaos",firstLetter:"s"},{word:"Scurry",reg:"chaos",firstLetter:"s"},{word:"Sniff",reg:"mundane",firstLetter:"s"},{word:"Scramble",reg:"chaos",firstLetter:"s"},{word:"Snap",reg:"chaos",firstLetter:"s"},{word:"Rattle",reg:"chaos",firstLetter:"r"},{word:"Race",reg:"chaos",firstLetter:"r"},{word:"Yap",reg:"chaos",firstLetter:"y"},{word:"Bound",reg:"mundane",firstLetter:"b"},{word:"Barrel",reg:"chaos",firstLetter:"b"},{word:"Chase",reg:"chaos",firstLetter:"c"},{word:"Bolt",reg:"chaos",firstLetter:"b"},{word:"Burrow",reg:"chaos",firstLetter:"b"},{word:"Tear",reg:"chaos",firstLetter:"t"},{word:"Scrape",reg:"chaos",firstLetter:"s"},{word:"Scratch",reg:"chaos",firstLetter:"s"},{word:"Charge",reg:"chaos",firstLetter:"c"},{word:"Pounce",reg:"chaos",firstLetter:"p"},{word:"Launch",reg:"chaos",firstLetter:"l"},{word:"Spring",reg:"chaos",firstLetter:"s"},{word:"Lunge",reg:"chaos",firstLetter:"l"}],
  german:      [{word:"March",reg:"grand",firstLetter:"m"},{word:"Drill",reg:"mundane",firstLetter:"d"},{word:"Patrol",reg:"grand",firstLetter:"p"},{word:"Guard",reg:"grand",firstLetter:"g"},{word:"Flank",reg:"grand",firstLetter:"f"},{word:"Advance",reg:"grand",firstLetter:"a"},{word:"Interceptor",reg:"mundane",firstLetter:"i"},{word:"Secure",reg:"grand",firstLetter:"s"},{word:"Enforce",reg:"grand",firstLetter:"e"},{word:"Deploy",reg:"grand",firstLetter:"d"},{word:"Command",reg:"grand",firstLetter:"c"},{word:"Execute",reg:"grand",firstLetter:"e"},{word:"Pursue",reg:"mundane",firstLetter:"p"},{word:"Track",reg:"mundane",firstLetter:"t"},{word:"Search",reg:"mundane",firstLetter:"s"},{word:"Control",reg:"grand",firstLetter:"c"},{word:"Dominate",reg:"grand",firstLetter:"d"},{word:"Protect",reg:"grand",firstLetter:"p"},{word:"Serve",reg:"mundane",firstLetter:"s"},{word:"Work",reg:"mundane",firstLetter:"w"},{word:"Drive",reg:"mundane",firstLetter:"d"},{word:"Course",reg:"grand",firstLetter:"c"},{word:"Direct",reg:"grand",firstLetter:"d"},{word:"Heel",reg:"mundane",firstLetter:"h"}],
  bulldog:     [{word:"Waddle",reg:"chaos",firstLetter:"w"},{word:"Shuffle",reg:"chaos",firstLetter:"s"},{word:"Lumber",reg:"mundane",firstLetter:"l"},{word:"Grunt",reg:"chaos",firstLetter:"g"},{word:"Snort",reg:"chaos",firstLetter:"s"},{word:"Grumble",reg:"chaos",firstLetter:"g"},{word:"Heave",reg:"mundane",firstLetter:"h"},{word:"Barge",reg:"chaos",firstLetter:"b"},{word:"Plod",reg:"chaos",firstLetter:"p"},{word:"Trundle",reg:"mundane",firstLetter:"t"},{word:"Sway",reg:"chaos",firstLetter:"s"},{word:"Trudge",reg:"mundane",firstLetter:"t"},{word:"Shamble",reg:"chaos",firstLetter:"s"},{word:"Lurch",reg:"chaos",firstLetter:"l"},{word:"Slog",reg:"chaos",firstLetter:"s"},{word:"Haul",reg:"mundane",firstLetter:"h"},{word:"Amble",reg:"mundane",firstLetter:"a"},{word:"Roll",reg:"chaos",firstLetter:"r"},{word:"Stagger",reg:"chaos",firstLetter:"s"},{word:"Stomp",reg:"mundane",firstLetter:"s"},{word:"Tromp",reg:"mundane",firstLetter:"t"},{word:"Snuffle",reg:"mundane",firstLetter:"s"},{word:"Wheeze",reg:"chaos",firstLetter:"w"},{word:"Puff",reg:"chaos",firstLetter:"p"}],
  dachshund:   [{word:"Scuttle",reg:"chaos",firstLetter:"s"},{word:"Waddle",reg:"chaos",firstLetter:"w"},{word:"Burrow",reg:"chaos",firstLetter:"b"},{word:"Squeeze",reg:"chaos",firstLetter:"s"},{word:"Tunnel",reg:"mundane",firstLetter:"t"},{word:"Wriggle",reg:"chaos",firstLetter:"w"},{word:"Slither",reg:"chaos",firstLetter:"s"},{word:"Stretch",reg:"mundane",firstLetter:"s"},{word:"Nose",reg:"mundane",firstLetter:"n"},{word:"Sniff",reg:"mundane",firstLetter:"s"},{word:"Hunt",reg:"mundane",firstLetter:"h"},{word:"Course",reg:"grand",firstLetter:"c"},{word:"Track",reg:"mundane",firstLetter:"t"},{word:"Pursue",reg:"mundane",firstLetter:"p"},{word:"Follow",reg:"mundane",firstLetter:"f"},{word:"Root",reg:"mundane",firstLetter:"r"},{word:"Probe",reg:"mundane",firstLetter:"p"},{word:"Explore",reg:"mundane",firstLetter:"e"},{word:"Investigate",reg:"mundane",firstLetter:"i"},{word:"Scent",reg:"mundane",firstLetter:"s"},{word:"Dig",reg:"chaos",firstLetter:"d"},{word:"Scramble",reg:"chaos",firstLetter:"s"},{word:"Work",reg:"mundane",firstLetter:"w"},{word:"Patrol",reg:"grand",firstLetter:"p"}],
  lurcher:     [{word:"Bolt",reg:"chaos",firstLetter:"b"},{word:"Flash",reg:"chaos",firstLetter:"f"},{word:"Streak",reg:"chaos",firstLetter:"s"},{word:"Dart",reg:"chaos",firstLetter:"d"},{word:"Lurk",reg:"mundane",firstLetter:"l"},{word:"Scamper",reg:"chaos",firstLetter:"s"},{word:"Nip",reg:"mundane",firstLetter:"n"},{word:"Sprint",reg:"chaos",firstLetter:"s"},{word:"Ghost",reg:"mundane",firstLetter:"g"},{word:"Slip",reg:"mundane",firstLetter:"s"},{word:"Course",reg:"grand",firstLetter:"c"},{word:"Arrow",reg:"chaos",firstLetter:"a"},{word:"Blur",reg:"chaos",firstLetter:"b"},{word:"Tear",reg:"chaos",firstLetter:"t"},{word:"Surge",reg:"chaos",firstLetter:"s"},{word:"Race",reg:"chaos",firstLetter:"r"},{word:"Chase",reg:"chaos",firstLetter:"c"},{word:"Hunt",reg:"mundane",firstLetter:"h"},{word:"Lope",reg:"mundane",firstLetter:"l"},{word:"Bound",reg:"mundane",firstLetter:"b"},{word:"Dash",reg:"chaos",firstLetter:"d"},{word:"Fly",reg:"chaos",firstLetter:"f"},{word:"Hurtle",reg:"chaos",firstLetter:"h"},{word:"Launch",reg:"chaos",firstLetter:"l"}],
  dalmatian:   [{word:"Dash",reg:"chaos",firstLetter:"d"},{word:"Dart",reg:"chaos",firstLetter:"d"},{word:"Dazzle",reg:"chaos",firstLetter:"d"},{word:"Sprint",reg:"chaos",firstLetter:"s"},{word:"Spot",reg:"mundane",firstLetter:"s"},{word:"Flash",reg:"chaos",firstLetter:"f"},{word:"Race",reg:"chaos",firstLetter:"r"},{word:"Charge",reg:"chaos",firstLetter:"c"},{word:"Patrol",reg:"grand",firstLetter:"p"},{word:"Stride",reg:"grand",firstLetter:"s"},{word:"Bound",reg:"mundane",firstLetter:"b"},{word:"Parade",reg:"grand",firstLetter:"p"},{word:"March",reg:"grand",firstLetter:"m"},{word:"Gallop",reg:"mundane",firstLetter:"g"},{word:"Hurtle",reg:"chaos",firstLetter:"h"},{word:"Course",reg:"grand",firstLetter:"c"},{word:"Chase",reg:"chaos",firstLetter:"c"},{word:"Blaze",reg:"chaos",firstLetter:"b"},{word:"Rocket",reg:"chaos",firstLetter:"r"},{word:"Streak",reg:"chaos",firstLetter:"s"},{word:"Arrow",reg:"chaos",firstLetter:"a"}],
  sheepdog:    [{word:"Shuffle",reg:"chaos",firstLetter:"s"},{word:"Shamble",reg:"chaos",firstLetter:"s"},{word:"Shaggle",reg:"mundane",firstLetter:"s"},{word:"Wobble",reg:"chaos",firstLetter:"w"},{word:"Wander",reg:"mundane",firstLetter:"w"},{word:"Mooch",reg:"mundane",firstLetter:"m"},{word:"Mosey",reg:"mundane",firstLetter:"m"},{word:"Bumble",reg:"chaos",firstLetter:"b"},{word:"Blunder",reg:"chaos",firstLetter:"b"},{word:"Lumber",reg:"mundane",firstLetter:"l"},{word:"Lollop",reg:"mundane",firstLetter:"l"},{word:"Plod",reg:"chaos",firstLetter:"p"},{word:"Amble",reg:"mundane",firstLetter:"a"},{word:"Meander",reg:"mundane",firstLetter:"m"},{word:"Toddle",reg:"chaos",firstLetter:"t"},{word:"Trundle",reg:"mundane",firstLetter:"t"},{word:"Sway",reg:"chaos",firstLetter:"s"},{word:"Drift",reg:"mundane",firstLetter:"d"},{word:"Roam",reg:"mundane",firstLetter:"r"},{word:"Stray",reg:"mundane",firstLetter:"s"},{word:"Dawdle",reg:"mundane",firstLetter:"d"},{word:"Traipse",reg:"mundane",firstLetter:"t"},{word:"Ramble",reg:"mundane",firstLetter:"r"}],
  labradoodle: [{word:"Boing",reg:"chaos",firstLetter:"b"},{word:"Flop",reg:"chaos",firstLetter:"f"},{word:"Wriggle",reg:"chaos",firstLetter:"w"},{word:"Nuzzle",reg:"mundane",firstLetter:"n"},{word:"Waggle",reg:"mundane",firstLetter:"w"},{word:"Bounce",reg:"chaos",firstLetter:"b"},{word:"Fluff",reg:"mundane",firstLetter:"f"},{word:"Wiggle",reg:"chaos",firstLetter:"w"},{word:"Snuggle",reg:"mundane",firstLetter:"s"},{word:"Frolic",reg:"chaos",firstLetter:"f"},{word:"Zoom",reg:"mundane",firstLetter:"z"},{word:"Gambol",reg:"chaos",firstLetter:"g"},{word:"Careen",reg:"chaos",firstLetter:"c"},{word:"Hurtle",reg:"chaos",firstLetter:"h"},{word:"Tumble",reg:"chaos",firstLetter:"t"},{word:"Leap",reg:"mundane",firstLetter:"l"},{word:"Spring",reg:"chaos",firstLetter:"s"},{word:"Bound",reg:"mundane",firstLetter:"b"},{word:"Lollop",reg:"mundane",firstLetter:"l"},{word:"Waddle",reg:"chaos",firstLetter:"w"},{word:"Squirm",reg:"chaos",firstLetter:"s"},{word:"Scramble",reg:"chaos",firstLetter:"s"},{word:"Pounce",reg:"chaos",firstLetter:"p"}],
  default:     [{word:"Lope",reg:"mundane",firstLetter:"l"},{word:"Prowl",reg:"grand",firstLetter:"p"},{word:"Stride",reg:"grand",firstLetter:"s"},{word:"Roam",reg:"mundane",firstLetter:"r"},{word:"Slink",reg:"mundane",firstLetter:"s"},{word:"Stalk",reg:"grand",firstLetter:"s"},{word:"Saunter",reg:"mundane",firstLetter:"s"},{word:"Canter",reg:"mundane",firstLetter:"c"},{word:"Wander",reg:"mundane",firstLetter:"w"},{word:"Amble",reg:"mundane",firstLetter:"a"},{word:"Meander",reg:"mundane",firstLetter:"m"},{word:"Ramble",reg:"mundane",firstLetter:"r"},{word:"Mooch",reg:"mundane",firstLetter:"m"},{word:"Drift",reg:"mundane",firstLetter:"d"},{word:"Cruise",reg:"mundane",firstLetter:"c"},{word:"Pad",reg:"mundane",firstLetter:"p"},{word:"Traipse",reg:"mundane",firstLetter:"t"},{word:"Mosey",reg:"mundane",firstLetter:"m"},{word:"Dawdle",reg:"mundane",firstLetter:"d"},{word:"Plod",reg:"chaos",firstLetter:"p"},{word:"Shuffle",reg:"chaos",firstLetter:"s"},{word:"March",reg:"grand",firstLetter:"m"},{word:"Trek",reg:"mundane",firstLetter:"t"}],
};
...
function generateScored(breed: string, surname: string, gender: "boy"|"girl", seed: number, town = "", colour: DogColour = "") {
  ...
  if (styleRoll === 0 && validAbbrevs.length > 0) {
    ...
    // Derive nickname from meaning -- pick most distinctive word (longest, not first)
    const meaningWords = abbrev.meaning.split(" ");
    // Filter out common filler words
    const fillerWords = new Set(["of","the","a","an","and","or","for","to","in","is","are","most","very","top","big","head","real","true","young","old","first","last","no","new","boss","king","queen","lady","girl","boy","man"]);
    const contentWords = meaningWords.filter(w => !fillerWords.has(w.toLowerCase()));
    const nickSource = contentWords.sort((a,b) => b.length - a.length)[0] || meaningWords[meaningWords.length-1];
    nickname = nickSource.length <= 5 ? nickSource : nickSource.slice(0, 5);
    ...
    nickname = getNickname(firstName.name);
  } else if (styleRoll === 6 && gender === "boy" && !["collie","retriever","sighthound","german","spaniel","welsh","giant","afghan","poodle","sniffer"].includes(group2)) {
    ...
    if (surnameHasPrefix) {
      ...
      const mcPrefixPool = MCFACE_PREFIX_BOY;
  ...
  } else if (styleRoll === 7 && gender === "boy" && ["boxer","terrier","character","lapdog","boston","asian","dachshund","bulldog","default"].includes(group2)) {
    ...
    const sbMid = SPONGEBOB_MID_BOY[(seed + 53) % SPONGEBOB_MID_BOY.length];
