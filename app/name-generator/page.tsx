...
const NAMES: Record<string, { boy: NameEntry[]; girl: NameEntry[] }> = {
  lapdog: {
    ...
    girl: [{name:"Fabulous",reg:"absurd",syllables:3},{name:"Darling",reg:"baby",syllables:2},{name:"Precious",reg:"baby",syllables:2},{name:"Divine",reg:"grand",syllables:2},{name:"Dazzling",reg:"absurd",syllables:2},{name:"Ruby",reg:"grand",syllables:2},{name:"Diamond",reg:"grand",syllables:2},{name:"Pearl",reg:"grand",syllables:1},{name:"Sapphire",reg:"grand",syllables:2},{name:"Crystal",reg:"grand",syllables:2},{name:"Chanel",reg:"grand",syllables:2},{name:"Celestine",reg:"grand",syllables:3},{name:"Aurora",reg:"grand",syllables:3},{name:"Daphne",reg:"grand",syllables:2},{name:"Diana",reg:"grand",syllables:3},{name:"Flora",reg:"nature",syllables:2},{name:"Freya",reg:"grand",syllables:2},{name:"Iris",reg:"nature",syllables:2},{name:"Luna",reg:"grand",syllables:2},{name:"Maeve",reg:"grand",syllables:1},{name:"Ophelia",reg:"grand",syllables:4},{name:"Pandora",reg:"grand",syllables:3},{name:"Venus",reg:"grand",syllables:2},{name:"Violette",reg:"grand",syllables:3},{name:"Juliet",reg:"grand",syllables:3},{name:"Isabella",reg:"grand",syllables:4},{name:"Charlotte",reg:"grand",syllables:2},{name:"Olivia",reg:"mundane",syllables:4},{name:"Victoria",reg:"grand",syllables:4},{name:"Elizabeth",reg:"grand",syllables:4},{name:"Booboo",reg:"baby",syllables:2},{name:"Gigi",reg:"baby",syllables:2},{name:"Mimi",reg:"baby",syllables:2},{name:"Fifi",reg:"baby",syllables:2},{name:"Lulu",reg:"baby",syllables:2},{name:"Coco",reg:"baby",syllables:2},{name:"Snugglebum",reg:"baby",syllables:3},{name:"Cuddlekins",reg:"baby",syllables:3},{name:"Squishface",reg:"baby",syllables:2},{name:"Fluffybum",reg:"baby",syllables:3},{name:"Puddingkins",reg:"baby",syllables:3},{name:"Baby-Baby",reg:"baby",syllables:2},{name:"Trixie-Trix",reg:"baby",syllables:2},{name:"Lola-Lo",reg:"baby",syllables:2},{name:"Coco-Co",reg:"baby",syllables:2},{name:"Didi-Di",reg:"baby",syllables:2},{name:"Mimi-Mi",reg:"baby",syllables:2},{name:"Fifi-Fee",reg:"baby",syllables:2},{name:"Lulu-Lu",reg:"baby",syllables:2},{name:"Riri-Ri",reg:"baby",syllables:2},{name:"Gigi-Gi",reg:"baby",syllables:2},{name:"Booboo-Boo",reg:"baby",syllables:2},{name:"Pixie-Pix",reg:"baby",syllables:2},{name:"Honey-Hon",reg:"baby",syllables:2},{name:"Trixie-Lee",reg:"baby",syllables:2},{name:"Chantelle-Marie",reg:"baby",syllables:2},{name:"Destiny-Rose",reg:"baby",syllables:2},{name:"Lexie-Lou",reg:"baby",syllables:2},{name:"Pixie-Lou",reg:"baby",syllables:2},{name:"Honey-Rose",reg:"baby",syllables:2},{name:"Crystal-Lee",reg:"baby",syllables:2},{name:"Chardonnay-Rose",reg:"baby",syllables:2},{name:"Kayleigh-Lou",reg:"baby",syllables:2},{name:"Sapphire-Lee",reg:"baby",syllables:2},{name:"Diamond-Rose",reg:"baby",syllables:2},{name:"Destiny-Lou",reg:"baby",syllables:2},{name:"Shaniece-May",reg:"baby",syllables:2},{name:"Chardonnay-May",reg:"baby",syllables:2},{name:"D-Vine",reg:"baby",syllables:2},{name:"D-Licious",reg:"baby",syllables:2},{name:"D-Lovely",reg:"baby",syllables:2},{name:"L-Amour",reg:"baby",syllables:2},{name:"D-Arcy",reg:"baby",syllables:2},{name:"Chardonnay",reg:"baby",syllables:2},{name:"Shaniece",reg:"baby",syllables:2},{name:"Destinee",reg:"baby",syllables:2},{name:"Lexie",reg:"baby",syllables:2},{name:"Trixie",reg:"baby",syllables:2},{name:"Pixie",reg:"baby",syllables:2},{name:"Chantelle",reg:"baby",syllables:2},{name:"Shaniqua",reg:"baby",syllables:2},{name:"Kayleigh",reg:"baby",syllables:2},{name:"Crystelle",reg:"baby",syllables:2},{name:"Shaylee",reg:"baby",syllables:2},{name:"Britnee",reg:"baby",syllables:2},{name:"Jorjia",reg:"baby",syllables:2}],
  },
  boxer: {
    ...
    girl: [{name:"Dizzy",reg:"chaos",syllables:2},{name:"Topsy",reg:"chaos",syllables:2},{name:"Bonkers",reg:"chaos",syllables:2},{name:"Wibble",reg:"chaos",syllables:2},{name:"Doolally",reg:"chaos",syllables:3},{name:"Ramshackle",reg:"chaos",syllables:3},{name:"Twinkles",reg:"baby",syllables:2},{name:"Cornflake",reg:"food",syllables:2},{name:"Booboo",reg:"baby",syllables:2},{name:"Tutu",reg:"baby",syllables:2},{name:"Gigi",reg:"baby",syllables:2},{name:"Mimi",reg:"baby",syllables:2},{name:"Fifi",reg:"baby",syllables:2},{name:"Lulu",reg:"baby",syllables:2},{name:"Snugglebum",reg:"baby",syllables:3},{name:"Cuddlekins",reg:"baby",syllables:3},{name:"Squishface",reg:"baby",syllables:2},{name:"Babbycakes",reg:"baby",syllables:3},{name:"Tiddlywink",reg:"baby",syllables:3},{name:"Fluffybum",reg:"baby",syllables:3},{name:"Jellybean",reg:"food",syllables:3},{name:"Candyfloss",reg:"food",syllables:3},{name:"Cupcake",reg:"food",syllables:2},{name:"Trixie-Trix",reg:"baby",syllables:2},{name:"Lola-Lo",reg:"baby",syllables:2},{name:"Chardonnay",reg:"baby",syllables:2},{name:"Destiny-Rose",reg:"baby",syllables:2},{name:"Lexie-Lou",reg:"baby",syllables:2},{name:"Baby-Baby",reg:"baby",syllables:2},{name:"Pixie-Pix",reg:"baby",syllables:2},{name:"D-Vine",reg:"baby",syllables:2},{name:"Trixie",reg:"baby",syllables:2},{name:"Kayleigh-Lou",reg:"baby",syllables:2}],
  },
  sighthound: {
  ...
  retriever: {
    ...
    girl: [{name:"Treacle",reg:"food",syllables:2},{name:"Trifle",reg:"food",syllables:2},{name:"Muffin",reg:"food",syllables:2},{name:"Pudding",reg:"food",syllables:2},{name:"Eclair",reg:"food",syllables:2},{name:"Crumpet",reg:"food",syllables:2},{name:"Waffle",reg:"food",syllables:2},{name:"Biscuit",reg:"food",syllables:2},{name:"Brownie",reg:"food",syllables:2},{name:"Pavlova",reg:"food",syllables:3},{name:"Charlotte",reg:"mundane",syllables:2},{name:"Margaret",reg:"mundane",syllables:3},{name:"Dorothy",reg:"mundane",syllables:3},{name:"Edith",reg:"mundane",syllables:2},{name:"Florence",reg:"mundane",syllables:2},{name:"Beatrice",reg:"grand",syllables:3},{name:"Constance",reg:"mundane",syllables:2},{name:"Millicent",reg:"grand",syllables:3},{name:"Booboo",reg:"baby",syllables:2},{name:"Mimi",reg:"baby",syllables:2},{name:"Lulu",reg:"baby",syllables:2},{name:"Snugglebum",reg:"baby",syllables:3},{name:"Jellybean",reg:"food",syllables:3},{name:"Candyfloss",reg:"food",syllables:3},{name:"Cupcake",reg:"food",syllables:2},{name:"Truffle",reg:"food",syllables:2},{name:"Nugget",reg:"food",syllables:2},{name:"Popcorn",reg:"food",syllables:2},{name:"Beanbag",reg:"food",syllables:2},{name:"Nibbins",reg:"food",syllables:2},{name:"Cookie",reg:"food",syllables:2},{name:"Cracker",reg:"food",syllables:2},{name:"Kipper",reg:"food",syllables:2},{name:"Sardine",reg:"food",syllables:2},{name:"Prawn",reg:"food",syllables:2},{name:"Pickles",reg:"food",syllables:2},{name:"Pippin",reg:"food",syllables:2},{name:"Pip",reg:"food",syllables:2},{name:"Pipsqueak",reg:"food",syllables:2},{name:"Sprout",reg:"food",syllables:2},{name:"Goose",reg:"food",syllables:2},{name:"Smudge",reg:"food",syllables:2},{name:"Dribbles",reg:"food",syllables:2},{name:"Whiskers",reg:"food",syllables:2},{name:"Splodge",reg:"food",syllables:2}],
  },
  collie: {
...
const NICKNAMES: Record<string,string> = {
  ...
  "jorjia": "Jorj",
  "shaylee": "Shay",
  "britnee": "Brit",kerfuffle:"Kerfie",chuckles:"Chuck",pickles:"Picks",noodles:"Noods",
  chipmunk:"Chip",
};
