...
const NAMES: Record<string, { boy: NameEntry[]; girl: NameEntry[] }> = {
  ...
  boston: {
    ...
    {name:"Moxie",reg:"chaos",syllables:2},{name:"Spunk",reg:"chaos",syllables:1}
  ],
  },
  default: {
...
function getGroup(breed: string): string {
  ...
  if (["pug","siberian husky","chihuahua","corgi"].includes(b)) return "character";
