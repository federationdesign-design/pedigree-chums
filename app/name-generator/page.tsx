...
const NAMES: Record<string, { boy: string[]; girl: string[] }> = {
  ...
  boxer: {
    ...
    girl: ["Dizzy","Topsy","Bonkers","Wibble","Doolally","Piggledy","Turvy","Ramshackle","Teacup","Booboo","Tutu","Heels","Twinkles","Cornflake","Wee-mama","Sasspanties","Booboo","Tutu","Woo-Woo","Noo-Noo","Goo-Goo","Coo-Coo","Zsa-Zsa","Gigi","Mimi","Fifi","Cici","Didi","Bibi","Lulu","Kiki","Vivi","Riri","Nini","Titi","Sisi","Jojo","Coco","Yoyo","Bobo","Zaza","Bebe","Gaga","Snugglebum","Cuddlekins","Squishface","Babbycakes","Ickle","Teensy","Tiddlywink","Piddlekins","Snuggleface","Cuddlepaws","Fluffybum","Smooshface","Squeezy","Bitsy","Itsy","Ditsy","Bubbly","Wobbly","Wiggly","Squiggly","Snooky-Wookums","Honey-Bunny","Puddingkins","Lambchop","Jellybean","Gumdrop","Lollipop","Candyfloss","Marshmallow","Fluffernutter","Wee-Mama","Pumpkinhead","Cupcake"],
  },
  sighthound: {
  ...
  sniffer: {
    ...
    girl: ["Gloomsbury","Woesworth","Mournington","Doleful","Plaintive","Lamentia","Wistfulina","Sorrowful","Droopington","Sadlington","Lacrimosa","Lamentabilis","Lugubria","Tristesse","Melancolie","Despondina","Grievance","Desolata","Morosina","Miseria","Booboo","Tutu","Woo-Woo","Noo-Noo","Goo-Goo","Coo-Coo","Zsa-Zsa","Gigi","Mimi","Fifi","Cici","Didi","Bibi","Lulu","Kiki","Vivi","Riri","Nini","Titi","Sisi","Jojo","Coco","Yoyo","Bobo","Zaza","Bebe","Gaga","Snugglebum","Cuddlekins","Squishface","Babbycakes","Ickle","Teensy","Tiddlywink","Piddlekins","Snuggleface","Cuddlepaws","Fluffybum","Smooshface","Squeezy","Bitsy","Itsy","Ditsy","Bubbly","Wobbly","Wiggly","Squiggly","Snooky-Wookums","Honey-Bunny","Puddingkins","Lambchop","Jellybean","Gumdrop","Lollipop","Candyfloss","Marshmallow","Fluffernutter","Wee-Mama","Pumpkinhead","Cupcake"],
  },
  giant: {
    ...
    girl: ["Titchy","WeeDee","Petite","Dinky","Lilliput","Minikin","Daintybell","Thistledown","Gossamera","Featherina","Pixie","Elfin","Pixy","Twiggy","Mote","Speck","Iota","Smidge","Milly","Molly","Booboo","Tutu","Woo-Woo","Noo-Noo","Goo-Goo","Coo-Coo","Zsa-Zsa","Gigi","Mimi","Fifi","Cici","Didi","Bibi","Lulu","Kiki","Vivi","Riri","Nini","Titi","Sisi","Jojo","Coco","Yoyo","Bobo","Zaza","Bebe","Gaga","Snugglebum","Cuddlekins","Squishface","Babbycakes","Ickle","Teensy","Tiddlywink","Piddlekins","Snuggleface","Cuddlepaws","Fluffybum","Smooshface","Squeezy","Bitsy","Itsy","Ditsy","Bubbly","Wobbly","Wiggly","Squiggly","Snooky-Wookums","Honey-Bunny","Puddingkins","Lambchop","Jellybean","Gumdrop","Lollipop","Candyfloss","Marshmallow","Fluffernutter","Wee-Mama","Pumpkinhead","Cupcake"],
  },
  terrier: {
    ...
    girl: ["Frenzina","Rampeena","Commotica","Furory","Clamoureena","Pandemonia","Anarchia","Mischief","Turbulence","Whirlwind","Tempest","Gale","Gail","Gayle","Tempesta","Tempestt","Tempist","Booboo","Tutu","Woo-Woo","Noo-Noo","Goo-Goo","Coo-Coo","Zsa-Zsa","Gigi","Mimi","Fifi","Cici","Didi","Bibi","Lulu","Kiki","Vivi","Riri","Nini","Titi","Sisi","Jojo","Coco","Yoyo","Bobo","Zaza","Bebe","Gaga","Snugglebum","Cuddlekins","Squishface","Babbycakes","Ickle","Teensy","Tiddlywink","Piddlekins","Snuggleface","Cuddlepaws","Fluffybum","Smooshface","Squeezy","Bitsy","Itsy","Ditsy","Bubbly","Wobbly","Wiggly","Squiggly","Snooky-Wookums","Honey-Bunny","Puddingkins","Lambchop","Jellybean","Gumdrop","Lollipop","Candyfloss","Marshmallow","Fluffernutter","Wee-Mama","Pumpkinhead","Cupcake"],
  },
  retriever: {
  ...
  collie: {
    ...
    girl: ["Frenzied","Hyperactive","Incessant","Ceaseless","Tireless","Restless","Vigilant","Anxious","Compulsive","Driven","Manic","Feverish","Frantic","Agitated","Overwrought","High-strung","Hyperkinetic","Relentless","Fiona","Catriona","Morag","Isla","Kirsty","Ailsa","Rhona","Shona","Flora","Heather","Booboo","Tutu","Woo-Woo","Noo-Noo","Goo-Goo","Coo-Coo","Zsa-Zsa","Gigi","Mimi","Fifi","Cici","Didi","Bibi","Lulu","Kiki","Vivi","Riri","Nini","Titi","Sisi","Jojo","Coco","Yoyo","Bobo","Zaza","Bebe","Gaga","Snugglebum","Cuddlekins","Squishface","Babbycakes","Ickle","Teensy","Tiddlywink","Piddlekins","Snuggleface","Cuddlepaws","Fluffybum","Smooshface","Squeezy","Bitsy","Itsy","Ditsy","Bubbly","Wobbly","Wiggly","Squiggly","Snooky-Wookums","Honey-Bunny","Puddingkins","Lambchop","Jellybean","Gumdrop","Lollipop","Candyfloss","Marshmallow","Fluffernutter","Wee-Mama","Pumpkinhead","Cupcake"],
  },
  poodle: {
    ...
    girl: ["Dialectique","Epistemique","Ontologie","Semantique","Axiomatique","Hermeneutique","Phenomenologie","Teleologie","Eschatologie","Deontologie","Metaphysique","Colette","Marguerite","Simone","Yvette","Brigitte","Monique","Claudette","Giselle","Hypatia","Cornelia","Booboo","Tutu","Woo-Woo","Noo-Noo","Goo-Goo","Coo-Coo","Zsa-Zsa","Gigi","Mimi","Fifi","Cici","Didi","Bibi","Lulu","Kiki","Vivi","Riri","Nini","Titi","Sisi","Jojo","Coco","Yoyo","Bobo","Zaza","Bebe","Gaga","Snugglebum","Cuddlekins","Squishface","Babbycakes","Ickle","Teensy","Tiddlywink","Piddlekins","Snuggleface","Cuddlepaws","Fluffybum","Smooshface","Squeezy","Bitsy","Itsy","Ditsy","Bubbly","Wobbly","Wiggly","Squiggly","Snooky-Wookums","Honey-Bunny","Puddingkins","Lambchop","Jellybean","Gumdrop","Lollipop","Candyfloss","Marshmallow","Fluffernutter","Wee-Mama","Pumpkinhead","Cupcake"],
  },
  dachshund: {
  ...
  spaniel: {
    ...
    girl: ["Georgiana","Arabella","Clementine","Millicent","Cordelia","Beatrice","Frederica","Constance","Prudence","Imogen","Sophronia","Wilhelmina","Henrietta","Lavinia","Dorothea","Rosalind","Griselda","Ermengarde","Etheldreda","Aldgitha","Booboo","Tutu","Woo-Woo","Noo-Noo","Goo-Goo","Coo-Coo","Zsa-Zsa","Gigi","Mimi","Fifi","Cici","Didi","Bibi","Lulu","Kiki","Vivi","Riri","Nini","Titi","Sisi","Jojo","Coco","Yoyo","Bobo","Zaza","Bebe","Gaga","Snugglebum","Cuddlekins","Squishface","Babbycakes","Ickle","Teensy","Tiddlywink","Piddlekins","Snuggleface","Cuddlepaws","Fluffybum","Smooshface","Squeezy","Bitsy","Itsy","Ditsy","Bubbly","Wobbly","Wiggly","Squiggly","Snooky-Wookums","Honey-Bunny","Puddingkins","Lambchop","Jellybean","Gumdrop","Lollipop","Candyfloss","Marshmallow","Fluffernutter","Wee-Mama","Pumpkinhead","Cupcake"],
  },
  scottish: {
    ...
    girl: ["Niamh","Aoife","Grainne","Siobhan","Deirdre","Orla","Maeve","Brigid","Fiona","Catriona","Morag","Ishbel","Finella","Effie","Nessa","Astrid","Seren","Heather","Laurel","Clary","Alyssum","Thyme","Sorrel","Yarrow","Booboo","Tutu","Woo-Woo","Noo-Noo","Goo-Goo","Coo-Coo","Zsa-Zsa","Gigi","Mimi","Fifi","Cici","Didi","Bibi","Lulu","Kiki","Vivi","Riri","Nini","Titi","Sisi","Jojo","Coco","Yoyo","Bobo","Zaza","Bebe","Gaga","Snugglebum","Cuddlekins","Squishface","Babbycakes","Ickle","Teensy","Tiddlywink","Piddlekins","Snuggleface","Cuddlepaws","Fluffybum","Smooshface","Squeezy","Bitsy","Itsy","Ditsy","Bubbly","Wobbly","Wiggly","Squiggly","Snooky-Wookums","Honey-Bunny","Puddingkins","Lambchop","Jellybean","Gumdrop","Lollipop","Candyfloss","Marshmallow","Fluffernutter","Wee-Mama","Pumpkinhead","Cupcake"],
  },
  highenergy: {
...
const TITLES_BOY: Record<string, string[]> = {
  ...
  giant:       ["Great","Magnificent","Formidable","Legendary","Unstoppable","Duke","Earl","Baron"],
  poodle:      ["Professor","Doctor"],
  lapdog:      ["Reverend","Dean","Bishop","Archdeacon"],
  character:   ["Notorious","Incomparable","Inimitable","Illustrious","Baron","Inspector","Judge"],
  gentry:      ["Viscount","Baron","Right Honourable","Lord","Sir"],
  highenergy:  ["Lieutenant","Sergeant","Captain"],
  lowactivity: ["Private","Lance Corporal","Magnificent"],
  scottish:    ["Lord","Duke","Sir","Earl"],
  historical:  ["Notorious","Legendary","Incomparable"],
  doodle:      ["Professor","Major","Inspector","Magnificent"],
  default:     ["Major","Inspector","Baron","Lord"],
};

const TITLES_GIRL: Record<string, string[]> = {
  terrier:     ["Miss"],
  spaniel:     ["Dame","Lady","Countess","Duchess","Viscountess","Marchioness"],
  retriever:   ["Dame","Lady","Countess","Viscountess","Baroness"],
  german:      ["Countess","Dame","Baroness","Lady"],
  collie:      ["Professor","Doctor","Lady","Dame"],
  boxer:       ["Dame","Lady","Countess","Baroness"],
  sniffer:     ["Lady","Dame","Countess","Viscountess","Doctor"],
  sighthound:  ["Duchess","Countess","Lady","Dame","Viscountess","Baroness","Marchioness"],
  giant:       ["Great","Magnificent","Formidable","Legendary","Unstoppable","Duchess","Countess","Lady","Dame"],
  poodle:      ["Professor","Doctor"],
  lapdog:      ["Mother Superior","Prioress","Reverend Mother"],
  character:   ["Notorious","Incomparable","Inimitable","Illustrious","Baroness","Countess"],
  gentry:      ["Viscountess","Baroness","Most Honourable","Lady","Dame","Marchioness"],
  highenergy:  ["Lady","Countess","Dame","Duchess"],
  lowactivity: ["Lady","Baroness","Magnificent","Countess"],
  scottish:    ["Lady","Duchess","Dame","Countess","Marchioness"],
  historical:  ["Notorious","Legendary","Incomparable"],
  doodle:      ["Professor","Doctor","Lady","Magnificent"],
  default:     ["Lady","Baroness","Countess","Dame","Viscountess"],
};
...
function getNickname(firstName: string): string {
  ...
  const shortcuts: Record<string, string> = {
    ...
    snooky: "Snooks", jellybean: "Jelly", marshmallow: "Marsh", candyfloss: "Candy",
    puddingkins: "Pudds", lambchop: "Lamby", fluffernutter: "Nutter", pumpkinhead: "Pumps",
