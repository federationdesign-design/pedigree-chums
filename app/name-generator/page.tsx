...
const NICKNAMES: Record<string,string|string[]> = {
  archibald:["Archie","Arch","Baldie","Baldy"],bartholomew:"Baz",cornelius:"Cornie",reginald:"Reggie",algernon:"Algie",
  peregrine:["Perry","Pip","Pippin","Greenie"],maximillian:"Max",maximilian:"Max",humphrey:"Humph",montgomery:"Monty",
  ferdinand:["Ferdy","Fred","Nando","Fern"],alexander:"Alex",sebastian:"Seb",theodore:"Teddy",frederick:"Freddie",
  wellington:"Welly",percival:"Percy",wilfred:"Wilf",sherlock:"Sherl",hercule:"Herc",
  augustus:["Gus","Augie","Auggie","Gussy"],auberon:"Aubs",barnaby:"Barnie",benedictus:"Benny",fortunatus:"Forty",
...
kerfuffle:"Kerfie",chuckles:"Chuck",pickles:"Picks",noodles:"Noods",
  chipmunk:"Chip",
  alastair:["Al","Ali","Ally","Astie","Sandy"],
  laurence:["Loz","Lozza","Laurie","Lawrie","Lawie"],
  llewellyn:["Llew","Lew","Lyn","Welly"],
  sebastien:["Seb","Sebby","Basty","Baz"],
  robert:["Rob","Robbie","Bob","Bobby","Bert"],
  james:["Jim","Jimmy","Jamie","Jem"],
  john:"Jack",
  jonathan:["Jon","Johnny","Jonny","Nathan"],
  joseph:["Joe","Joey","Jojo","Seph"],
  thomas:["Tom","Tommy","Thom","Tam"],
  charles:["Charlie","Charley","Chaz","Chuck"],
  michael:["Mike","Mikey","Mick","Micky"],
  david:["Dave","Davey","Davy","Dai"],
  daniel:["Dan","Danny","Danno","Dani"],
  samuel:["Sam","Sammy","Sammie","Saul"],
  benjamin:["Ben","Benny","Benji","Benjy"],
  christopher:["Chris","Chrissy","Kit","Topher"],
  nicholas:["Nick","Nicky","Nico","Cole"],
  andrew:["Andy","Drew","Ando","Dandy"],
  anthony:["Tony","Ant","Anton","Nino"],
  matthew:["Matt","Matty","Mats","Theo"],
  patrick:["Pat","Paddy","Rick","Ricky"],
  peter:"Pete",
  stephen:["Steve","Stevie","Steph","Ste"],
  steven:["Steve","Stevie","Ste","Sven"],
  philip:["Phil","Philly","Pip","Flip"],
  francis:["Frank","Frankie","Fran","Franny"],
  george:["Georgie","Geordie","Geo","Georgy"],
  albert:["Al","Bert","Bertie","Albie"],
  alfred:["Alf","Alfie","Fred","Freddie"],
  arthur:["Art","Artie","Arty","Thor"],
  walter:["Walt","Wally","Wat","Wal"],
  kenneth:["Ken","Kenny","Kent","Kendo"],
  donald:"Don",
  ronald:["Ron","Ronnie","Rolo","Naldo"],
  raymond:["Ray","Raymie","Raymo","Mondy"],
  gerald:["Gerry","Jerry","Gez","Geri"],
  jeremiah:["Jerry","Jez","Jem","Jeremy"],
  jeremy:["Jez","Jezza","Jerry","Jem"],
  timothy:["Tim","Timmy","Timo","Mothy"],
  gregory:["Greg","Gregg","Greggy","Rory"],
  douglas:["Doug","Dougie","Dug","Duggie"],
  vincent:["Vin","Vince","Vinnie","Vinny"],
  victor:"Vic",
  leonard:["Len","Lenny","Leo","Nard"],
  leonardo:"Leo",
  dominic:["Dom","Dommy","Nick","Nico"],
  nathaniel:["Nate","Nat","Nathan","Niel"],
  nathan:"Nate",
  zachary:["Zach","Zack","Zak","Zacky"],
  zachariah:"Zach",
  isaac:"Ike",
  isaiah:"Izzy",
  elijah:"Eli",
  joshua:["Josh","Joshy","Joss","Jo"],
  jacob:"Jake",
  ezekiel:"Zeke",
  emmanuel:["Manny","Manu","Em","Nuel"],
  maxwell:"Max",
  augustine:"Gus",
  bertram:"Bert",
  bernard:["Bernie","Bern","Barney","Nard"],
  benedict:["Ben","Benny","Ned","Bendy"],
  brandon:"Bran",
  bradley:"Brad",
  ...
  cecil:"Cec",
  cedric:"Ced",
  clarence:["Clare","Clarry","Larry","Ren"],
  clement:["Clem","Clemmy","Clemmie","Cley"],
  clifford:"Cliff",
  conrad:"Con",
  cuthbert:"Bert",
  desmond:["Des","Desi","Dez","Mondy"],
  dexter:"Dex",
  edmund:["Ed","Eddie","Ned","Mundy"],
  edwin:["Ed","Eddie","Ned","Winnie"],
  elliot:["Eli","Ell","Ellis","Lio"],
  elliott:"Eli",
  eugene:"Gene",
  fletcher:"Fletch",
  franklin:"Frank",
  geoffrey:["Geoff","Jeff","Jeffy","Geo"],
  gideon:"Gid",
  gilbert:["Gil","Gilly","Bert","Bertie"],
  gordon:"Gord",
  graham:"Gray",
  harold:["Harry","Hal","Haz","Haroldy"],
  harrison:["Harry","Harris","Sonny","Hazza"],
  howard:"Howie",
  ignatius:["Iggy","Nate","Nacho","Ignas"],
  irving:"Irv",
  jackson:"Jack",
  jasper:"Jas",
  jefferson:"Jeff",
  ...
  lionel:"Lion",
  lucas:"Luke",
  lucian:["Luke","Luc","Luca","Luce"],
  malcolm:["Mal","Malc","Colm","Malky"],
  marcus:["Marc","Mark","Marco","Mars"],
  martin:"Marty",
  maurice:"Mo",
  mortimer:"Mort",
  neville:"Nev",
  nigel:"Nige",
  orlando:["Lando","Orly","Rolly","Landy"],
  oswald:["Oz","Ozzie","Ossie","Wally"],
  oscar:"Oz",
  phineas:"Finn",
  randolph:"Randy",
  raphael:["Raph","Raffy","Rafe","Raf"],
  reuben:"Rube",
  roderick:["Rod","Roddy","Rick","Rory"],
  rodney:"Rod",
  roger:"Rog",
  roland:"Roly",
  rudolph:["Rudy","Rudi","Dolph","Dolf"],
  rupert:["Roo","Rupes","Bertie","Rupe"],
  russell:"Russ",
  samson:"Sam",
  solomon:["Sol","Solly","Sonny","Solo"],
  stuart:"Stu",
  sylvester:["Sly","Syl","Vester","Ves"],
  tobias:["Toby","Tobes","Tobe","Bias"],
  tristan:"Tris",
  ulysses:"Uly",
  valentine:["Val","Vallie","Tiny","Tino"],
  vernon:"Vern",
  wilbert:"Will",
  wilbur:"Will",
  xavier:"Xav",
  yorick:"Rick",
  abraham:["Abe","Bram","Abie","Hammy"],
  adrian:["Ade","Adi","Aidy","Rian"],
  alan:"Al",
  alistair:"Al",
  ambrose:"Amby",
  angus:["Gus","Angie","Angy","Gussy"],
  arnold:"Arnie",
  aubrey:"Aub",
  avery:"Ave",
  baxter:"Bax",
  ...
  carlton:"Carl",
  chester:"Chet",
  christian:["Chris","Kit","Christy","Ian"],
  colin:"Col",
  connor:"Con",
  cyril:"Cy",
  damian:"Damo",
  ...
  kriemhild:"Krie",
  kunigunde:"Kuni",
  lawrence:["Loz","Lozza","Laurie","Larry","Lawie"],
  leopold:["Leo","Poldy","Lenny","Lee"],
  lilliput:"Lilli",
  livia:"Liv",
  louis:"Lou",
  lucy:"Lu",
  ...
  qadir:"Qad",
  quasar:"Quas",
  quentin:["Quent","Quin","Quinn","Quinny"],
  raoul:"Raoul",
  ramshackle:"Rammy",
  rené:"Ren",
  reza:"Rez",
  ...
  yuki:"Yuki",
  zen:"Zen",
  winston:["Win","Winnie","Sonny","Winty"],otto:"Ot",bertie:"Bert",monty:"Monty",percy:"Perce",
  reggie:"Reg",buster:"Bus",gruff:"Gruff",grunt:"Grunt",clive:"Clive",
  boris:"Bo",derek:"Del",norman:"Norm",frank:"Frank",dennis:"Den",
  stanley:["Stan","Stanny","Lee"],herbert:"Herb",ernest:"Ernie",pudding:"Pudds",
            ...
            <div style={{ background:"var(--navy)", borderRadius:20, padding:"clamp(20px,4vw,36px)" }}>
              ...
              <button onClick={handleGenerate} className="display"
                ...
                Find my chum’s name
                    ...
                    {/* ── QUESTION STAGE (after exhausted -- breed/surname fixed, just answer more Qs) ── */}
          {stage === "question" && (
            <div style={{display:"flex",flexDirection:"column",gap:16}}>
              <div style={{background:"var(--navy)",borderRadius:20,padding:"16px 24px",color:"#fff",fontFamily:"var(--font-body)",fontSize:"0.9rem",opacity:0.8,textAlign:"center"}}>
                {breed} · {surname} · {gender === "boy" ? "Boy" : "Girl"}
              </div>
              <div style={{background:"#f0f8ff",borderRadius:20,padding:"clamp(16px,3vw,28px)"}}>
                <p style={{fontFamily:"var(--font-display)",fontSize:"1.1rem",color:"var(--navy)",marginBottom:16,textAlign:"center"}}>
                  Answer a few more questions to unlock fresh names
                </p>
                {qIndices.map((qi: number, pos: number) => {
                  const qItem = QUESTION_BANK[qi];
                  if (!qItem) return null;
                  return (
                    <div key={qi} style={{marginBottom:16}}>
                      <p style={{fontFamily:"var(--font-body)",fontWeight:600,color:"var(--navy)",marginBottom:8}}>{qItem.text}</p>
                      <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
                        {qItem.options.map((opt: {label:string;bonus:string[]}) => (
                          <button key={opt.label} onClick={() => setQAnswers((prev: Record<number,string>) => ({...prev,[pos]:opt.label}))}
                            style={{padding:"8px 18px",borderRadius:10,border:"2px solid var(--navy)",
                              background:qAnswers[pos]===opt.label?"var(--navy)":"transparent",
                              color:qAnswers[pos]===opt.label?"#fff":"var(--navy)",
                ...
                <button onClick={() => {
                  ...
                  setSeed(s);
                  setStage("reveal");
                  // handleGenerate equivalent -- trigger via seed change
                  // Actually we need to call generate directly
                  const bonus1: string[] = [];
                  const bonus2: string[] = [];
                  qIndices.forEach((qi: number, p: number) => {
                    const qItem = QUESTION_BANK[qi];
                    const chosen = qAnswers[p];
                    if (!chosen || !qItem) return;
                    const chosenOpt = qItem.options.find((o: {label:string;bonus:string[]}) => o.label === chosen);
                    if (chosenOpt) bonus1.push(...chosenOpt.bonus);
                    qItem.options.filter((o: {label:string;bonus:string[]}) => o.label !== chosen)
                  ...
                  const allRanked = ranked.length>0 ? ranked : rankResults(allD,breed?getGroup(breed):"default");
                  const fresh = allRanked.filter((r: Result) => !usedNicknames.has(r.nickname));
                  if (fresh.length === 0) { setStage("exhausted"); return; }
                  const result = fresh.slice(0,1);
                  const fn = result[0]?.full?.split(" ").find((w:string) => w.length > 1 && /^[A-Z]/.test(w) && !w.includes(".")) ?? "";
                  setUsedNicknames((prev:Set<string>) => new Set([...prev, ...result.map((r:Result) => r.nickname)]));
                  setUsedFirstNames((prev:Set<string>) => fn ? new Set([...prev, fn]) : prev);
                  setResults(result);
                  setStage("reveal");
                }} className="display" style={{padding:"14px 32px",borderRadius:14,border:"none",background:"var(--navy)",color:"#fff",
                  fontSize:"1.1rem",cursor:"pointer",fontFamily:"var(--font-display)",letterSpacing:"0.04em",
...
{/* ── STAGE 3: REVEAL ── */}
          ...
          {stage === "exhausted" && (
            <div style={{background:"linear-gradient(to top right,#00e2ff,#008eff)",borderRadius:40,padding:"clamp(24px,4vw,40px)",textAlign:"center",color:"#fff"}}>
              ...
              <button onClick={() => {
                // Keep breed/surname/gender and ALL previous used names -- just pick fresh questions
                setQIndices(pickThreeQuestions());
                setQAnswers({});
                setQOpen(true);
                setStage("question");
              }}
