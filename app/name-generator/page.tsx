...
<div style={{ borderTop:"1px solid rgba(255,255,255,0.12)", paddingTop:18, marginBottom: snOpen ? 0 : 22 }}>
                <button
                  ...
                  <span style={{ color:"#ffffff", fontSize:"0.7rem", fontWeight:700, textTransform:"uppercase", letterSpacing:"0.1em", fontFamily:"var(--font-body)" }}>
                    Personalise surname
                ...
                <button
                  ...
                  <span style={{ flex:1, textAlign:"center", color:"var(--yellow)", fontSize:"0.7rem", fontWeight:700, textTransform:"uppercase", letterSpacing:"0.1em", fontFamily:"var(--font-body)" }}>
