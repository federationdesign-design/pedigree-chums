...
const MCFACE_POOL: Record<string, [string, string][]> = {
  ...
  lapdog: [["Fluffy","Fluff"],["Boingy","Boing"],["Prancy","Prance"],["Glittery","Glitter"]],
  ...
  spaniel: [["Splashy","Splash"],["Waggy","Wag"],["Fetchy","Fetch"],["Frolicky","Frolic"],["Scampy","Scamp"]],
  german: [["Strict","Stric"]],
  ...
  dalmatian: [["Spotty","Spot"],["Dotty","Dot"],["Dashing","Dash"],["Flashy","Flash"],["Streaky","Streak"],["Patchy","Patch"],["Blinky","Blink"],["Waggy","Wag"]],
  labradoodle: [["Waggy","Wag"],["Fluffy","Fluff"],["Curly","Curl"],["Floppy","Flop"],["Splashy","Splash"],["Wiggly","Wiggle"],["Noodly","Noodle"]],
  corgi: [["Waddy","Wadd"],["Stumpy","Stump"],["Bossy","Boss"],["Trotty","Trot"],["Nippy","Nip"],["Herdy","Herd"]],
  default: [["Chompy","Chomp"],["Scrappy","Scrap"],["Waggy","Wag"],["Snappy","Snap"],["Zippy","Zip"],["Nosy","Nose"]]
};
...
const MCFACE_SUFFIX: Record<string, string[]> = {
  ...
  retriever: ["chops","tum","chomps","jowls","paws","bum","tail"],
  terrier: ["butt","chops","snoot","paws","tail","ears"],
  boxer: ["snout","jowls","chops","butt","tum","snort","face"],
  character: ["snout","jowls","butt","chops","face","tum","belly"],
  lapdog: ["bum","face","paws","ears","tail","chops","snoot"],
  collie: ["paws","tail","butt","chops","ears","face","snoot"],
  poodle: ["face","snoot","paws","chops","tail","bum","ears"],
  sighthound: ["butt","tail","paws","face","snoot","chops","ears"],
  dachshund: ["bum","butt","tail","tum","chops","face","snoot"],
  giant: ["butt","tum","jowls","chops","paws","face","snout"],
  greatdane: ["butt","paws","tail","face","chops","snoot","tum"],
  spaniel: ["ears","paws","tail","chops","face","snoot","belly"],
  german: ["paws","tail","face","chops","butt","snoot","ears"],
  asian: ["snout","jowls","tum","chops","butt","face","snort"],
  boston: ["butt","chops","face","snoot","ears","paws","tail"],
  afghan: ["tail","face","paws","snoot","butt","ears","chops"],
  bulldog: ["jowls","snout","chops","tum","butt","face","belly"],
  default: ["butt","face","chops","paws","tail","snoot","bum"]
};
