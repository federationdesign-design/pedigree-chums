...
const TITLES_GIRL: Record<string, string[]> = {
  ...
  giant:       ["The Great","The Magnificent","The Formidable","The Legendary","The Unstoppable","Duchess","Countess","Lady","Dame"],
  poodle:      ["Professor","Doctor"],
  lapdog:      ["Mother Superior","Abbess","Prioress","Sister","Reverend Mother"],
  character:   ["The Notorious","The Incomparable","The Inimitable","The Illustrious","Baroness","Countess"],
  gentry:      ["Viscountess","Baroness","The Most Honourable","Lady","Dame","Marchioness"],
  highenergy:  ["Lady","Countess","Dame","Duchess"],
  lowactivity: ["Lady","Baroness","The Magnificent","Countess"],
  scottish:    ["Lady","Duchess","Dame","Countess","Marchioness"],
  historical:  ["The Notorious","The Legendary","The Incomparable"],
  doodle:      ["Professor","Doctor","Lady","The Magnificent"],
