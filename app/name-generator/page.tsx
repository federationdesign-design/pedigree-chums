...
const NAMES: Record<string, { boy: NameEntry[]; girl: NameEntry[] }> = {
  ...
  sniffer: {
    ...
    girl: [{name:"Gloomsbury",reg:"absurd",syllables:3},{name:"Woesworth",reg:"absurd",syllables:2},{name:"Doleful",reg:"absurd",syllables:2},{name:"Booboo",reg:"baby",syllables:2},{name:"Mimi",reg:"baby",syllables:2},{name:"Fifi",reg:"baby",syllables:2},{name:"Snugglebum",reg:"baby",syllables:3},{name:"Cuddlekins",reg:"baby",syllables:3},{name:"Lollypop",reg:"food",syllables:3},{name:"Gobstopper",reg:"food",syllables:3},{name:"Toffee",reg:"food",syllables:2},{name:"Sherbet",reg:"food",syllables:2},{name:"Humbug",reg:"food",syllables:2}],
  },
  greatdane: {
  ...
  collie: {
    ...
    girl: [{name:"Fiona",reg:"mundane",syllables:3},{name:"Morag",reg:"mundane",syllables:2},{name:"Isla",reg:"mundane",syllables:2},{name:"Kirsty",reg:"mundane",syllables:2},{name:"Flora",reg:"nature",syllables:2},{name:"Heather",reg:"nature",syllables:2},{name:"Booboo",reg:"baby",syllables:2},{name:"Snugglebum",reg:"baby",syllables:3}],
  },
  poodle: {
  ...
  dachshund: {
    ...
    girl: [{name:"Slinky",reg:"absurd",syllables:2},{name:"Helga",reg:"mundane",syllables:2},{name:"Greta",reg:"mundane",syllables:2},{name:"Hilde",reg:"mundane",syllables:2},{name:"Ursula",reg:"mundane",syllables:3},{name:"Booboo",reg:"baby",syllables:2},{name:"Mimi",reg:"baby",syllables:2},{name:"Lulu",reg:"baby",syllables:2},{name:"Fifi",reg:"baby",syllables:2},{name:"Snugglebum",reg:"baby",syllables:3}],
  },
  german: {
