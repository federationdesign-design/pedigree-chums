...
export const PAGE_BIOS: PageBio[] = [
  ...
  { route: '/home', name: 'Home', bio: 'The front page. An overview of our offering', extended: 'The front door. Everything branches off here. Pick a direction and go.', sequence: ['oh! hello! come in come in', 'would you like a cup of tea? i can do tea. sit down, sit anywhere', 'i wasnt expecting anyone. i would have TIDIED if i knew friends were stopping over'] },
  { route: '/about', name: 'About', bio: 'A page about the product.', extended: 'What this thing is and who made it. Read it if you like knowing.', misreadOpening: 'your on the about page, I think this page is about me right?', misreads: ['Did you know Boxers have one of the highest cancer rates of any breed. Thats basically the highest. I am top of something at least', 'Did you know Boxers have a heart condition thats unique to us. nobody else gets it. it can be fatal if its not managed, so yearly checks at the doctor dog', 'ok, yes, i look like i was hit with a frying pan. My flat face limits my exercise. so im not lazy. im limited', 'Boxers can live for eleven years. Everyday gets their day, mine just comes sooner than them little terriers. The smaller the dog the longer it lives. i didnt know that.', 'i dread to think what i cost. it says £2k per year to keep going. whatever £2k is', 'at least I am not difficult to train, I am one of the easier dogs to train because I respond to reward based training, as in im greedy', 'our puppy energy lasts for years. so im still a puppy now I think', 'they named us after boxers because we stand up and spar with our paws.', 'our ancestor was a German dog called a bullenbeisser. It means Bull Biter.', 'theres supposed to be a famous boxers called George. he did the mustard adverts on TV and he went to schools for head strokes.'] },
  ...
  { route: '/smarter-than-the-test', name: 'Smarter Than the Test', bio: 'Learn about dog intelligence', extended: 'A test of dog brains. See if we beat it. We usually do.', sequence: ['oh this is the clever test. they put us dogs in ORDER of how clever we are', 'i came somewhere in the middle. which is the BEST place. exactly averagely clever', 'the ones at the top just do what theyre told. thats not clever, thats obedient. ask me anything, go on'] },
