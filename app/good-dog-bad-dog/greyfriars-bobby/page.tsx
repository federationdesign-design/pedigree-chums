        ...
        <div className={styles.essayLayout}>
          <article className={styles.essay}>
            ...
            <div className={styles.essayBody}>
              <h3 className={styles.subhead}>The story that grew larger than the life</h3>
              ...
              <h3 className={styles.subhead}>The dog who stayed</h3>
              ...
              <h3 className={styles.subhead}>What the behaviour actually tells us</h3>
              ...
              <h3 className={styles.subhead}>Was Bobby a Skye Terrier?</h3>
              ...
              <h3 className={styles.subhead}>The statue that completed the story</h3>
              ...
              <h3 className={styles.subhead}>What Bobby tells us</h3>
