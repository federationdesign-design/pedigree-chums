...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: ["/hound-of-the-baskervilles.jpg"],
  },
};
...
const HEADLINE = "The Hound of the Baskervilles: How a Dog Was Made into a Monster";
  ...
  "@graph": [
    {
      ...
      image: `${SITE_URL}/hound-of-the-baskervilles.jpg`,
      publisher: { "@id": `${SITE_URL}/#organization` },
      mainEntityOfPage: `${SITE_URL}/good-dog-bad-dog/hound-of-the-baskervilles`,
    },
    {
      "@type": "BreadcrumbList",
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: HEADLINE, item: `${SITE_URL}/good-dog-bad-dog/hound-of-the-baskervilles` },
      ],
    },
  ],
};
