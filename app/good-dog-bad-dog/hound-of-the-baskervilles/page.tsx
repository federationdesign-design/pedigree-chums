      ...
      <main className={styles.essayPage}>
        ...
        <article className={styles.essay}>
          ...
          <div className={styles.essayBody}>
            ...
            <p>Here is the detail that gives the whole novel away.</p>
            <p>Stapleton does not rely on the dog's natural appearance. He paints the animal's head and body with phosphorus, so that it glows in the darkness of the moor. Think about what that tells you.</p>
