...
export const metadata: Metadata = {
  title: "[INTERNAL PREVIEW] Argos v2 -- Scroll Scenes Comparison",
  description: "Internal comparison build. Not for public indexing.",
...
export default function ArgosPage() {
  return (
    <>
      ...
      >
        INTERNAL PREVIEW -- V2 (fixed-timer quote scenes) -- not indexed, not linked from the live site
      </div>
