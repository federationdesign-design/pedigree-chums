  ...
  return (
            <div className={styles.sidebarCard}>
              <div style={{ padding: "16px 20px 4px" }}>
                <p style={{ fontFamily: "var(--font-display)", fontSize: "54px", textAlign: "center", letterSpacing: "0.12em", color: "var(--yellow-header)", textTransform: "uppercase", margin: "0 0 2px" }}>The Odyssey</p>
...
function LivingDescendantCard({ showImage = false }: { showImage?: boolean }) {
  return (
            <div className={styles.sidebarCard}>
              <div style={{ padding: "16px 20px 4px" }}>
                <p style={{ fontFamily: "var(--font-display)", fontSize: "54px", textAlign: "center", letterSpacing: "0.12em", color: "var(--yellow-header)", textTransform: "uppercase", margin: 0 }}>Living Descendant</p>
              </div>
              {showImage && (
...
function EditorsNoteCard() {
  return (
            <div className={styles.sidebarCard}>
              <div style={{ padding: "16px 20px 4px" }}>
                <p style={{ fontFamily: "var(--font-display)", fontSize: "54px", textAlign: "center", letterSpacing: "0.12em", color: "var(--yellow-header)", textTransform: "uppercase", margin: "0 0 8px" }}>Editor&apos;s Note</p>
              </div>
...
function ArgosIdentityCard() {
  return (
            <div className={styles.sidebarCard}>
              <div style={{ padding: "16px 20px 4px" }}>
                <p style={{ fontFamily: "var(--font-display)", fontSize: "54px", textAlign: "center", letterSpacing: "0.12em", color: "var(--yellow-header)", textTransform: "uppercase", margin: "0 0 4px" }}>ARGOS</p>
...
function InContextCard() {
  return (
            <div className={styles.sidebarCard}>
              <div style={{ padding: "16px 20px 4px" }}>
                <p style={{ fontFamily: "var(--font-display)", fontSize: "54px", textAlign: "center", letterSpacing: "0.12em", color: "var(--yellow-header)", textTransform: "uppercase", margin: 0 }}>In Context</p>
              </div>
              <div style={{ padding: "9px 50px 16px 50px" }}>
  ...
  return (
            <div className={styles.sidebarCard}>
              ...
              <div style={{ padding: "12px 20px 16px" }}>
                <p style={{ fontFamily: "var(--font-body)", fontSize: "0.95rem", fontWeight: 500, color: "#fff", lineHeight: 1.3 }}>*The often-cited 9-hour figure assumes mechanical reading at 250 wpm. In practice, <em style={{ fontWeight: 600 }}>The Odyssey</em> demands real concentration and a considered read. Reader beware!</p>
              </div>
            </div>
  );
}
...
function AboutHomerCard() {
  return (
            <div className={styles.sidebarCard}>
              <div style={{ padding: "16px 20px 4px" }}>
                <p style={{ fontFamily: "var(--font-display)", fontSize: "54px", textAlign: "center", letterSpacing: "0.12em", color: "var(--yellow-header)", textTransform: "uppercase", margin: 0 }}>About Homer</p>
              </div>
              ...
              <div style={{ padding: "14px 20px 16px" }}>
                ...
                <p style={{ fontFamily: "var(--font-body)", fontSize: "0.82rem", fontWeight: 700, color: "var(--yellow)", marginBottom: 12 }}>c. 800–700 BCE</p>
...
function WhatWeKnowCard() {
  return (
            <div className={styles.sidebarCard}>
              <div style={{ padding: "16px 20px 4px" }}>
                <p style={{ fontFamily: "var(--font-display)", fontSize: "54px", textAlign: "center", letterSpacing: "0.12em", color: "var(--yellow-header)", textTransform: "uppercase", margin: 0 }}>What We Know</p>
              </div>
...
function LikelyOriginsCard() {
  return (
            <div className={styles.sidebarCard}>
              <div style={{ padding: "16px 20px 4px" }}>
                <p style={{ fontFamily: "var(--font-display)", fontSize: "54px", textAlign: "center", letterSpacing: "0.12em", color: "var(--yellow-header)", textTransform: "uppercase", margin: 0 }}>Likely Origins</p>
              </div>
              <div style={{ padding: "9px 25px 16px 25px" }}>
...
function BuildAppearanceCard() {
  return (
            <div className={styles.sidebarCard}>
              <div style={{ padding: "16px 20px 4px" }}>
                <p style={{ fontFamily: "var(--font-display)", fontSize: "54px", textAlign: "center", letterSpacing: "0.12em", color: "var(--yellow-header)", textTransform: "uppercase", margin: 0 }}>Build &amp; <span style={{ fontSize: "0.86em" }}>Appearance</span></p>
              </div>
              <div style={{ padding: "9px 25px 16px 25px" }}>
                {[
...
function EstimatedSizeCard() {
  return (
            <div className={styles.sidebarCard}>
              <div style={{ padding: "16px 20px 12px" }}>
                <p style={{ fontFamily: "var(--font-display)", fontSize: "54px", textAlign: "center", letterSpacing: "0.12em", color: "var(--yellow-header)", textTransform: "uppercase", margin: 0 }}>Estimated Size</p>
              </div>
...
function SizeBuildCard() {
  return (
            <div className={styles.sidebarCard}>
              <div style={{ padding: "16px 20px 12px" }}>
                <p style={{ fontFamily: "var(--font-display)", fontSize: "54px", textAlign: "center", letterSpacing: "0.12em", color: "var(--yellow-header)", textTransform: "uppercase", margin: 0 }}>Size & Build</p>
              </div>
              ...
              <div className={styles.sizeBuildBullets} style={{ padding: "0 20px 16px" }}>
                {[
                  ...
                  <div key={item} style={{ display: "flex", gap: 10, marginBottom: 10, alignItems: "flex-start" }}>
                    ...
                    <p style={{ fontFamily: "var(--font-body)", fontSize: "0.87rem", fontWeight: 600, color: "#fff", lineHeight: 1.5, margin: 0, textAlign: "left" }}>{item}</p>
                  </div>
                ))}
              </div>
            </div>
...
// this page: headline is the on-page heading (which differs from the <title>),
// description reuses the metadata description, image is the real hero above.
// Author and publish date are omitted (the page has no honest source for either).
// Publisher links to the site-wide Organization node emitted in app/layout.tsx.
const HEADLINE = "Argos: The Dog Who Knew His Master";
  ...
  "@graph": [
    {
      ...
      image: `${SITE_URL}/history/Argos-hero.jpg`,
      publisher: { "@id": `${SITE_URL}/#organization` },
      mainEntityOfPage: `${SITE_URL}/good-dog-bad-dog/argos`,
    },
    {
      "@type": "BreadcrumbList",
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: HEADLINE, item: `${SITE_URL}/good-dog-bad-dog/argos` },
      ],
    },
  ],
};
        ...
        <div className={styles.essayLayout} id="article-start">
          ...
          <article className={styles.essay}>
            <div className={styles.essayBody}>
              ...
              <p>He appears only briefly in <em style={{ fontWeight: 600 }}>The Odyssey</em>. He does not fight a monster. He does not save a child. He does not lead anyone out of danger. He simply lifts his head, recognises the man he has waited for, wags his tail, and dies.</p>

              <p>And somehow, nearly three thousand years later, that is enough.</p>

              <p>Now that Christopher Nolan has brought <em style={{ fontWeight: 600 }}>The Odyssey</em> back into cinemas, Argos has returned too. Nolan has described <em style={{ fontWeight: 600 }}>The Odyssey</em> as <span style={{ color: "var(--yellow)", textDecoration: "underline" }}>&quot;the ultimate dog movie&quot;</span>, and has linked his own recent experience of becoming a dog owner to the importance of Argos in the story. In Homer, Argos is a tiny scene. In emotional terms, he is enormous.</p>

              <div className={styles.sceneMobile}>
                <NolanFilmCard />
              </div>

              <p>That may be because Argos is not just a loyal dog. He is something more complicated. <strong style={{ fontWeight: 700, color: "var(--yellow)" }}>He is the dog as memory. The dog as home. The dog as witness.</strong> The dog as proof that someone can be changed by war, time, disguise and suffering, and still be known by the creature who loved him before all of it.</p>

              <h2 className={styles.subhead}>The oldest dog reunion in literature</h2>

              <p>The Argos scene comes late in <em style={{ fontWeight: 600 }}>The Odyssey</em>, when Odysseus has finally returned to Ithaca after twenty years away. Ten years were spent at Troy. Another ten were spent trying to get home.</p>

              <p>But when he arrives, he cannot simply walk through the door and announce himself. His palace has been overrun by dudes who want his wife, consume his wealth and take his place. Odysseus returns disguised as a beggar. His survival depends on being unrecognised.</p>
              ...
              <p>Argos does not make a grand gesture. He does not speak. He does not perform some impossible feat. He does small, dog-like things. <span style={{ color: "var(--yellow)" }}>He lifts his head. He pricks his ears. He wags his tail. He recognises.</span></p>
                ...
                <HomerCrossfade
                  title={
                    <div style={{ padding: "16px 20px 12px", background: "var(--navy)", borderRadius: "16px 16px 0 0" }}>
                      <p style={{ fontFamily: "var(--font-display)", fontSize: "34px", textAlign: "center", letterSpacing: "0.12em", color: "var(--yellow-header)", textTransform: "uppercase", margin: 0 }}>About Homer</p>
                    </div>
                  }
                  header={
                    <>
                      ...
                      <div style={{ padding: "14px 20px 0" }}>
                        <p style={{ fontFamily: "var(--font-body)", fontSize: "0.95rem", fontWeight: 700, color: "#fff", marginBottom: 4 }}>Homer</p>
                        <p style={{ fontFamily: "var(--font-body)", fontSize: "0.82rem", fontWeight: 700, color: "var(--yellow)", marginBottom: 0 }}>c. 800–700 BCE</p>
                      </div>
                    </>
                  }
                  history={
                  ...
                  works={
                    <>
                      ...
                      <p style={{ fontFamily: "var(--font-display)", fontSize: "1.15rem", letterSpacing: "0.08em", textTransform: "uppercase", color: "var(--yellow-header)", marginBottom: 14, textAlign: "center" }}>Major Works</p>
                      {[
          ...
          <aside className={styles.sidebar}>
            ...
            <div className={styles.sidebarOnly}>
              ...
              <div className={`${styles.sceneMobile} ${styles.timelineScene} ${styles.tightTop}`} id="tl-scene">
                <p style={{ fontFamily: "var(--font-display)", fontSize: "54px", textAlign: "center", letterSpacing: "0.12em", color: "var(--yellow-header)", textTransform: "uppercase", lineHeight: 0.9, margin: "0 0 18px" }}>Ancestral Lineage</p>
