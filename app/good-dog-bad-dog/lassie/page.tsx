      ...
      <main className={styles.essayPage}>
        ...
        <article className={styles.essay}>
          ...
          <div className={styles.essayBody}>
            ...
            <p>Dogs are genuinely intelligent. When a dog looks at you, moves towards the door and then looks back, the interpretation -- "come with me, something is wrong" -- may be broadly right. But the dog has not constructed a sentence or weighed the options. Its behaviour is real. The human interpretation contains more certainty than the evidence supports.</p>
