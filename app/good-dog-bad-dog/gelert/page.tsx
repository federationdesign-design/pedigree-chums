...
const HEADLINE = "Gelert: The Dog Who Couldn’t Explain Himself";
  ...
  "@graph": [
    {
      ...
      image: `${SITE_URL}/gelert-painting.jpg`,
      publisher: { "@id": `${SITE_URL}/#organization` },
      mainEntityOfPage: `${SITE_URL}/good-dog-bad-dog/gelert`,
    },
    {
      "@type": "BreadcrumbList",
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: HEADLINE, item: `${SITE_URL}/good-dog-bad-dog/gelert` },
      ],
    },
  ],
};
        ...
        <div className={styles.essayLayout}>
          ...
          <article className={styles.essay}>
            <div className={styles.essayBody}>
              ...
              <h2 className={styles.subhead}>Why he got it so wrong</h2>
              ...
              <h2 className={styles.subhead}>The dog who couldn't defend himself</h2>
              ...
              <h2 className={styles.subhead}>The irony hiding in plain sight</h2>
              ...
              <h2 className={styles.subhead}>What Gelert actually tells us</h2>
