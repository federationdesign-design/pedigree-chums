...
// from Vercel Edge Config so the owner can flip it on when ready and OFF instantly in the dashboard, in
// SECONDS, with NO redeploy. Deliberately runtime, not a build-time env var (same pattern as Task 171).
//
...
//   1. Create/connect a Vercel Edge Config store (Vercel sets the EDGE_CONFIG env).
