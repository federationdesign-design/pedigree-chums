...
| Hero image + alt (article 6) | `slides.ts` + `the-dog-that-gives-you-your-world-back/page.tsx` | Image RESOLVED 12 Aug: `/guide_dog_image.jpg` supplied and wired. `PLACEHOLDER_ARTICLE_6_ALT` still outstanding. | Steve supplies the hero alt text. The old plan to move `article3_hero.jpg` here is dropped: article 6 now has its own hero. |
