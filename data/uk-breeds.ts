...
export const ukBreeds: UKBreed[] = [
  ...
  { name: "English Mastiff", strip: "ancient-medieval", era: "Ancient", anchor: 150, note: "Britain's ancient war and guard dog, prized as far back as Roman times.", tag: "endangered" },
