...
export const ukBreeds: UKBreed[] = [
  ...
  { name: "Celtic Hound", strip: "ancient-medieval", era: "Ancient", anchor: 80, note: "Ancient war and hunting sighthound of the Celtic tribes, remembered as the legendary forebear of the Irish Wolfhound and Scottish Deerhound.", tag: "extinct", image: "/history/breeds/celtic-hound.jpg" },
  ...
  { name: "Buckhound", strip: "ancient-medieval", era: "Medieval", anchor: 1220, note: "Medieval pack hound bred to hunt the smaller fallow buck, lighter and faster than the great staghounds.", tag: "extinct", image: "/history/breeds/buckhound.jpg" },
  ...
  { name: "Black and Tan Terrier", strip: "c1700", era: "1700s", anchor: 1710, note: "One of the earliest terriers, the working ancestor behind the fell terriers and the Welsh Terrier.", tag: "extinct", image: "/history/breeds/black-and-tan-terrier.jpg" },
  ...
  { name: "Paisley Terrier", strip: "mid1800", era: "1860s", anchor: 1865, note: "Silky-coated Scottish show terrier bred from the Skye Terrier, and the direct forerunner of the Yorkshire Terrier.", tag: "extinct", image: "/history/breeds/paisley-terrier.jpg" },
  ...
  { name: "Cumberland Sheepdog", strip: "c1900", era: "Early 1900s", anchor: 1910, note: "Northern herding dog folded into the Border Collie in the early 1900s, also claimed as an Australian Shepherd ancestor.", tag: "extinct", image: "/history/breeds/cumberland-sheepdog.jpg" },
  { name: "Toy Bulldog", strip: "c1900", era: "to 1914", anchor: 1914, note: "Miniature Bulldog kept as a Victorian companion, last recorded in 1914 after the French Bulldog eclipsed it.", tag: "extinct", image: "/history/breeds/toy-bulldog.jpg" },
