...
// Turns the 84 cut-out PNGs (sheets 2 to 8 x 12 accessories, named
// blue_expr{2-8}_{accessory}.png; sheet 8, the worried face, added the same day) into WebP files the game reads, at
...
const want = [];
for (let e = 2; e <= 8; e++) for (const a of ACC) want.push([e, a, join(src, `blue_expr${e}_${a}.png`)]);
...
console.log("wrote 84 faces to " + out + " and public/rare7.webp");
