...
const PROGENITOR_STATUS: Record<string, BreedTag> = {
  ...
  "Old scenting Hounds": "extinct", "Old English Black & Tan Terrier": "extinct",
  ...
  "Ancient Spitz dogs":         "extinct",
  "Arctic sled Spitz":               "extinct",
  "Spitz-type dogs":                 "extinct",
  "Brabant Bullenbeisser":           "extinct",
  "German Bullenbeisser dogs":      "extinct",
  "Medieval Alaunts dogs": "extinct",
