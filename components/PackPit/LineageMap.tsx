  ...
  const rootCard = (cx: number, cy: number) => {
    ...
    <>
      ...
      >
        ...
        <>
          <rect x={-ROOT - 5} y={-ROOT - 5} width={ROOT * 2 + 10} height={ROOT * 2 + 10} rx={24} fill="var(--blue, #1497d6)" />
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span className={styles.dtText} style={{ fontFamily: "Luckiest Guy, system-ui", fontSize: "12px", color: "#0a3a57", textAlign: "center" }}>double tap</span>
            </div>
          </div>
        </div>
        );
