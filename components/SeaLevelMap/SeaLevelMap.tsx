...
/* Exported for the Medieval Domesday map outline (22 Sept 2026). */
export const GB: LL[] = [[1.35,51.13],[1.44,51.38],[0.9,51.5],[1.15,51.78],[1.57,52.08],[1.75,52.47],[1.3,52.93],[0.5,52.95],[0.2,52.8],[0.35,53.15],[0.12,53.58],[-0.08,54.12],[-0.6,54.49],[-1.2,54.7],[-1.42,55],[-2,55.77],[-2.13,55.9],[-2.5,56],[-3.2,56.05],[-2.58,56.28],[-2.9,56.46],[-2.45,56.7],[-2.07,57.15],[-1.82,57.6],[-2,57.69],[-3.3,57.72],[-4.2,57.5],[-3.77,57.86],[-3.65,58.12],[-3.08,58.44],[-3.02,58.64],[-3.37,58.67],[-5,58.62],[-5.25,58.15],[-5.3,57.9],[-5.8,57.7],[-5.7,57.28],[-5.83,57],[-6.22,56.73],[-5.47,56.42],[-5.8,55.3],[-5.6,55.42],[-4.8,55.9],[-4.63,55.46],[-4.86,54.63],[-4.05,54.83],[-3.3,54.95],[-3.64,54.5],[-3.2,54.1],[-2.9,54.05],[-3.05,53.82],[-3,53.4],[-3.86,53.33],[-4.6,53.4],[-4.68,53.3],[-4.77,52.79],[-4.08,52.41],[-4.7,52.1],[-5.3,51.88],[-5.1,51.7],[-4.7,51.67],[-4.2,51.55],[-3.17,51.45],[-2.6,51.6],[-2.7,51.45],[-3.47,51.2],[-4.53,51.02],[-4.95,50.55],[-5.71,50.07],[-5.2,49.96],[-4.14,50.35],[-3.64,50.22],[-3.4,50.62],[-2.9,50.72],[-2.45,50.52],[-1.95,50.68],[-1.3,50.78],[-0.78,50.73],[-0.14,50.82],[0.25,50.73],[0.97,50.91]];
...
/* Norway (the top-right land mass) removed at owner request, 22 Sept 2026. */
const SMALL: LL[][] = [
...
const LAND = "var(--cta)";
/* Option B (owner choice, 22 Sept 2026, after rolling back the ETOPO1 terrain):
   each lost-land layer gets its own fixed green by how deep it lies under today's
   sea, stepping darker from --cta as it gets deeper. Keyed by SHELF depth. */
const DEPTH_FILLS: Record<number, string> = {
  12: "color-mix(in srgb, var(--cta) 88%, black)",
  22: "color-mix(in srgb, var(--cta) 80%, black)",
  30: "color-mix(in srgb, var(--cta) 72%, black)",
  45: "color-mix(in srgb, var(--cta) 64%, black)",
  50: "color-mix(in srgb, var(--cta) 56%, black)",
  80: "color-mix(in srgb, var(--cta) 48%, black)",
  120: "color-mix(in srgb, var(--cta) 40%, black)",
};
