  ...
  return (
    <div className={styles.sidebarCard}>
      ...
      <div style={{ padding: "8px 40px 52px" }}>
        <p style={{ ...cardBody, fontSize: "0.78rem", color: "#ffffff" }}>These dogs are given free to the people who need them, funded almost entirely by public donations. Sources: Guide Dogs; Medical Detection Dogs.</p>
      </div>
    </div>
  );
}
