...
| FAQ003-006, FAQ011-014 `{{...}}` answers | `generated/faq.json` (from workbook) | Workbook FAQ answers Steve will paste into the workbook | NEEDS_STEVE item 5 (OI01) |
| Revised B01 buying templates | `app/pick-a-chum/data/collie-b01-revised-draft.ts` | DRAFT revised buying copy for approval at STOP 1 | NEEDS_STEVE item 7 |
| Random-dog control treatment | (styled build, Checkpoint 2) | To be proposed for approval | NEEDS_STEVE item 6 |
